...
initIndexes=CREATE INDEX SRUUID ON STATEMENTS (UUID,COMMITTED);; CREATE INDEX SRHS ON STATEMENTS (SUBJECT,PREDICATE,REND,COMMITTED);; CREATE INDEX SRHP ON STATEMENTS (PREDICATE,REND,COMMITTED);; CREATE INDEX SRHPO ON STATEMENTS (PREDICATE,OBJECT,REND,COMMITTED);; CREATE INDEX SRHO ON STATEMENTS (OBJECT,REND,COMMITTED);; CREATE INDEX SRHC ON STATEMENTS (COMMITTED,ID);; CREATE INDEX SRIE ON STATEMENTS (REND,ID);; CREATE INDEX SMETA ON STATEMENTS (METADATA);; CREATE INDEX SNG ON STATEMENTS (COMMITTED,REND,NAMEDGRAPHID) ;; CREATE INDEX SRHSSPOIO ON STATEMENTS (NAMEDGRAPHID,SUBJECT,PREDICATE,OBJECT,METADATA,REND,RSTART,ID);; CREATE INDEX SRHSSPOIO_NR ON STATEMENTS_NR (NAMEDGRAPHID,SUBJECT,PREDICATE,OBJECT,METADATA,ID);; CREATE INDEX SRMETA_NR ON STATEMENTS_NR (METADATA);; CREATE INDEX SRHS_NR ON STATEMENTS_NR (SUBJECT);; CREATE INDEX SRHP_NR ON STATEMENTS_NR (PREDICATE);; CREATE INDEX SRHO_NR ON STATEMENTS_NR (OBJECT);; CREATE INDEX SRHC_NR ON STATEMENTS_NR (COMMITTED);; CREATE INDEX NG_ITRM ON NAMEDGRAPHS (ID,HEND,COMMITTED,HSTART,REVISION,METAID);; CREATE INDEX NG_MH ON NAMEDGRAPHS (METAID,HEND,HSTART, ID);; CREATE INDEX NG_C ON NAMEDGRAPHS (COMMITTED);; CREATE INDEX NG_RHI ON NAMEDGRAPHS(REVISION,HSTART,ID);; CREATE INDEX NG_UUID ON NAMEDGRAPHS(UUID,HEND,ID);; CREATE INDEX NG_LM ON NAMEDGRAPHS(LASTMODIFIEDBY);; CREATE INDEX NG_UUDI ON NAMEDGRAPHS (ID,COMMITTED,HEND,UUID);; CREATE INDEX NG_IHR_NR ON NAMEDGRAPHS_NR (ID,COMMITTED,HSTART,REVISION);; CREATE INDEX NG_M_NR ON NAMEDGRAPHS_NR (METAID);; CREATE INDEX NG_RH_NR ON NAMEDGRAPHS_NR(REVISION,HSTART);; CREATE INDEX NG_UUIDR ON NAMEDGRAPHS_NR(UUID,ID);; CREATE INDEX NG_LMR ON NAMEDGRAPHS_NR(LASTMODIFIEDBY);; CREATE INDEX NG_C_NR ON NAMEDGRAPHS_NR (COMMITTED);; CREATE INDEX LTT ON LASTTRANSACTIONTIME (ID,COMMITED);; CREATE INDEX LTT4 ON LASTTRANSACTIONTIME (COMMITED,ID);; CREATE INDEX TID ON TRANSACTIONTIME (ID,COMMITED);; CREATE INDEX TCIU ON TRANSACTIONTIME (COMMITED,ID,URI);; CREATE INDEX TCSID ON TRANSACTIONTIME(SERVERID,COMMITED);; CREATE UNIQUE INDEX {0}_U_V ON {0}_U(VALUE);; CREATE INDEX {0}_U_RI ON {0}_U(REF DESC,ID);; CREATE INDEX {0}_U_RV ON {0}_U(REF ,VALUE);; CREATE INDEX {0}_LU_V ON {0}_LU(HASH,ID);; CREATE INDEX {0}_LU_RI ON {0}_LU(REF DESC,ID);; CREATE UNIQUE INDEX {0}_L_V ON {0}_L(VALUE,MODIFIER_ID);; CREATE INDEX {0}_L_RI ON {0}_L(REF DESC,ID);; CREATE INDEX {0}_L_RV ON {0}_L(REF ,MODIFIER_ID,VALUE);; CREATE UNIQUE INDEX {0}_TL_V ON {0}_TL(VALUE,MODIFIER_ID);; CREATE INDEX {0}_TL_RI ON {0}_TL(REF DESC,ID);; CREATE INDEX {0}_TL_RV ON {0}_TL(REF ,MODIFIER_ID,VALUE);; CREATE INDEX {0}_LL_V ON {0}_LL(HASH,MODIFIER_ID);; CREATE INDEX {0}_LL_RI ON {0}_LL(REF DESC,ID);; CREATE INDEX {0}_LTL_V ON {0}_LTL(HASH,MODIFIER_ID);; CREATE INDEX {0}_LTL_RI ON {0}_LTL(REF DESC,ID);; CREATE UNIQUE INDEX {0}_B_V ON {0}_B(VALUE);; CREATE INDEX {0}_B_RI ON {0}_B(REF DESC,ID);; CREATE INDEX {0}_B_RV ON {0}_B(REF ,VALUE);; CREATE INDEX {0}_UIDS_TI ON  {0}_USED_IDS(TRANSACTIONID,ID)   {1};; CREATE INDEX {0}_UIDS_IT ON  {0}_USED_IDS(ID,TRANSACTIONID)   {1};; CREATE UNIQUE INDEX LOCKEDS ON LOCKED_GRAPHS(TRANSACTIONID,ID);; CREATE UNIQUE INDEX LOCKEDID ON LOCKED_GRAPHS(ID);; CREATE UNIQUE INDEX QG_DSID_ID ON QUERY_GRAPHS(DSID,ID);; CREATE UNIQUE INDEX {0}_DATATYPE_VI ON {0}_DATATYPE(VALUE,ID)  {1};; CREATE UNIQUE INDEX {0}_DATATYPE_IV ON {0}_DATATYPE(ID,VALUE)  {1};; CREATE UNIQUE INDEX {0}_LANGUAGE_VI ON {0}_LANGUAGE(VALUE,ID)  {1};; CREATE UNIQUE INDEX {0}_LANGUAGE_IV ON {0}_LANGUAGE(ID,VALUE)  {1} ;; 
...
initTablespace=
createTemporaryTables=CREATE LOCAL TEMPORARY TABLE DEFAULTGRAPHS_TMP ( ID {6} NOT NULL ) ;; CREATE INDEX DEFAULTGRAPHS_IDX ON DEFAULTGRAPHS_TMP (ID);; CREATE LOCAL TEMPORARY TABLE NAMEDGRAPHS_TMP ( ID {6} NOT NULL ) ;; CREATE INDEX  NAMEDGRAPHS_IDX ON NAMEDGRAPHS_TMP (ID);; CREATE LOCAL TEMPORARY TABLE TEMPGRAPHS ( ID {6} NOT NULL );; CREATE INDEX  TEMPGRAPHS_IDX ON TEMPGRAPHS (ID);; CREATE LOCAL TEMPORARY TABLE TEMP_COLUMNS( C0    {6}, C1    {6}, C2    {6}, C3    {6}, C4    {6}, C5    {6}, C6    {6}, C7    {6}, C8    {6}, C9    {6}, C10    {6}, C11    {6}, C12    {6}, C13    {6}, C14    {6}, C15    {6} );; CREATE LOCAL TEMPORARY TABLE TEMP_CONSTRAINT0( ID    {6} );; CREATE INDEX CONSTRAINT0_IDX ON TEMP_CONSTRAINT0 (ID);; CREATE LOCAL TEMPORARY TABLE TEMP_CONSTRAINT1( ID    {6} );; CREATE INDEX CONSTRAINT1_IDX ON TEMP_CONSTRAINT1 (ID);; CREATE LOCAL TEMPORARY TABLE TEMP_CONSTRAINT2( ID    {6} );; CREATE INDEX CONSTRAINT2_IDX ON TEMP_CONSTRAINT2 (ID);; CREATE LOCAL TEMPORARY TABLE TEMP_CONSTRAINT3( ID    {6} );; CREATE INDEX CONSTRAINT3_IDX ON TEMP_CONSTRAINT3 (ID);; CREATE LOCAL TEMPORARY TABLE NGR_TMP( ID     {6}, METAID   {6}, REVISION   {6}, NEW_REVISION {6}, UUID   {6} ) ;; CREATE LOCAL TEMPORARY TABLE STMTS_REP_TMP ( ID     {7}({4}) {3} NOT NULL, NAMEDGRAPHID  {6}, SUBJECT       {6}, PREDICATE     {6}, OBJECT        {6}, RSTART    {6}, REND    {6} )  ;; CREATE INDEX STMTS_REP_INDEX1 ON STMTS_REP_TMP(NAMEDGRAPHID,REND);; CREATE LOCAL TEMPORARY TABLE SUBJECT_IDS_TEMP ( ID  {6} )ON COMMIT DELETE ROWS;; CREATE LOCAL TEMPORARY TABLE PREDICATE_IDS_TEMP ( ID  {6} )ON COMMIT DELETE ROWS;; CREATE LOCAL TEMPORARY TABLE OBJECT_IDS_TEMP ( ID  {6} )ON COMMIT DELETE ROWS;; CREATE LOCAL TEMPORARY TABLE NAMEDGRAPH_IDS_TEMP ( ID  {6} )ON COMMIT DELETE ROWS;; CREATE INDEX NGIDID ON NAMEDGRAPH_IDS_TEMP(ID);; CREATE LOCAL TEMPORARY TABLE ID_TMP ( ID  {6}, ENTRYID {6}, TYPE  {5} );; CREATE LOCAL TEMPORARY TABLE RES_TMP ( ENTRYID {6}, VALUE {7}({4}) {3} ) ;; CREATE INDEX  RES_TMP1 ON RES_TMP(VALUE,ENTRYID);; CREATE LOCAL TEMPORARY TABLE LIT_TMP ( ENTRYID {6}, VALUE  {7}({4}) {3}, MODIFIER_ID {6} ) ;; CREATE INDEX LIT_TMP1 ON LIT_TMP(VALUE,MODIFIER_ID,ENTRYID);; CREATE LOCAL TEMPORARY TABLE STMTS_TMP ( OPERATION   {5} NOT NULL, ID     {7}({4}) {3} NOT NULL, STMTID    {6} NOT NULL, METADATA   {5} NOT NULL, UUID    {6} NOT NULL, NAMEDGRAPHID  {6} NOT NULL, SUBJECT         {6} NOT NULL, PREDICATE        {6} NOT NULL, OBJECT          {6} NOT NULL, REVISION   {6} , COMMITTED   {6} NOT NULL ) ;; CREATE INDEX IF NOT EXISTS STMTS1 ON STMTS_TMP(OPERATION,ID);; CREATE INDEX IF NOT EXISTS STMTS2 ON STMTS_TMP(ID,OPERATION);; CREATE INDEX IF NOT EXISTS STMTS3 ON STMTS_TMP(STMTID,ID);; CREATE LOCAL TEMPORARY TABLE STMT_ID_TMP ( ID     {7}({4}) {3} NOT NULL, STMTID    {6} NOT NULL ) ;; CREATE INDEX IF NOT EXISTS STMT_ID_1 ON STMT_ID_TMP(STMTID,ID);; CREATE LOCAL TEMPORARY TABLE REMOVE_GRAPHS_TMP ( ID     {6} NOT NULL, TYPE    {5} NOT NULL, REND    {6} NOT NULL ) ;; CREATE INDEX IF NOT EXISTS RG_ID ON REMOVE_GRAPHS_TMP(TYPE,ID,REND);; 
...
InsertStatements.purgeInsertStatements=DELETE FROM {0}STMTS_TMP WHERE {0}STMTS_TMP.OPERATION=1 AND {0}STMTS_TMP.ID IN (SELECT S.ID FROM STATEMENTS S,{0}STMTS_TMP ST WHERE S.ID=ST.ID AND S.COMMITTED=0 AND S.REND IS NULL)
...
InsertStatements.purgeRemoveStatementsNR=DELETE FROM {0}STMTS_TMP WHERE {0}STMTS_TMP.OPERATION=0 AND {0}STMTS_TMP.ID NOT IN (SELECT S.ID FROM STATEMENTS_NR S,{0}STMTS_TMP ST WHERE S.ID=ST.ID AND S.COMMITTED=0 AND S.ID={0}STMTS_TMP.ID)
InsertStatements.commitTransactionNamedGraphs=UPDATE NAMEDGRAPHS SET COMMITTED=0 WHERE COMMITTED=?
InsertStatements.purgeInsertStatementsNR=DELETE FROM {0}STMTS_TMP WHERE {0}STMTS_TMP.OPERATION=1 AND {0}STMTS_TMP.ID IN (SELECT S.ID FROM STATEMENTS_NR S,{0}STMTS_TMP ST WHERE S.ID=ST.ID AND S.COMMITTED=0 AND S.ID={0}STMTS_TMP.ID)
...
InsertStatements.purgeRemoveStatements=DELETE FROM {0}STMTS_TMP WHERE {0}STMTS_TMP.OPERATION=0 AND {0}STMTS_TMP.ID NOT IN (SELECT S.ID FROM STATEMENTS S,{0}STMTS_TMP ST WHERE S.ID=ST.ID AND S.COMMITTED=0 AND S.REND IS NULL)

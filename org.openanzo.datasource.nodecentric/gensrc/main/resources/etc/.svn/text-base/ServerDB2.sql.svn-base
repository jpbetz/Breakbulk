...
initIndexes=ALTER TABLE STATEMENTS VOLATILE;; CREATE INDEX SRUUID ON STATEMENTS (UUID,COMMITTED) ALLOW REVERSE SCANS;; CREATE INDEX SRHEND ON STATEMENTS (COMMITTED,NAMEDGRAPHID,RSTART,REND) ALLOW REVERSE SCANS;; CREATE INDEX SID ON STATEMENTS (REND,ID) ALLOW REVERSE SCANS;; CREATE INDEX SRHSSPOIO ON STATEMENTS (NAMEDGRAPHID,SUBJECT,PREDICATE,OBJECT,REND,METADATA,RSTART,ID) ALLOW REVERSE SCANS;; CREATE INDEX SRHS ON STATEMENTS (SUBJECT,PREDICATE) ALLOW REVERSE SCANS;; CREATE INDEX SRHP ON STATEMENTS (PREDICATE,OBJECT) ALLOW REVERSE SCANS;; CREATE INDEX SRHO ON STATEMENTS (OBJECT) ALLOW REVERSE SCANS;; CREATE INDEX SRCM ON STATEMENTS (COMMITTED,ID) ALLOW REVERSE SCANS;; CREATE INDEX SNGID_NR ON STATEMENTS_NR (NAMEDGRAPHID) ALLOW REVERSE SCANS;; CREATE INDEX SID_NR ON STATEMENTS_NR (ID) ALLOW REVERSE SCANS;; CREATE INDEX SRHSSPOIO_NR ON STATEMENTS_NR (NAMEDGRAPHID,SUBJECT,PREDICATE,OBJECT,COMMITTED,METADATA) ALLOW REVERSE SCANS;; CREATE INDEX SRHS_NR ON STATEMENTS_NR (SUBJECT,PREDICATE) ALLOW REVERSE SCANS;; CREATE INDEX SRHP_NR ON STATEMENTS_NR (PREDICATE,OBJECT) ALLOW REVERSE SCANS;; CREATE INDEX SRHO_NR ON STATEMENTS_NR (OBJECT) ALLOW REVERSE SCANS;; CREATE INDEX SRCM_NR ON STATEMENTS_NR (COMMITTED,NAMEDGRAPHID) ALLOW REVERSE SCANS;; ALTER TABLE NAMEDGRAPHS VOLATILE;; CREATE INDEX NG_ITRM ON NAMEDGRAPHS (ID,HEND,HSTART,REVISION,METAID)ALLOW REVERSE SCANS;; CREATE INDEX NG_MH ON NAMEDGRAPHS (METAID,HEND,HSTART, ID)ALLOW REVERSE SCANS;; CREATE INDEX NG_RHI ON NAMEDGRAPHS(REVISION,HSTART,ID)ALLOW REVERSE SCANS;; CREATE INDEX NG_UUID ON NAMEDGRAPHS(UUID,HEND,ID) ALLOW REVERSE SCANS;; CREATE INDEX NG_COMM ON NAMEDGRAPHS(COMMITTED,HEND) ALLOW REVERSE SCANS;; CREATE INDEX NG_UUDI ON NAMEDGRAPHS (ID,COMMITTED,HEND,UUID) ALLOW REVERSE SCANS;; CREATE INDEX NG_IHR_NR ON NAMEDGRAPHS_NR (ID,HSTART,REVISION)ALLOW REVERSE SCANS;; CREATE INDEX NG_M_NR ON NAMEDGRAPHS_NR (METAID)ALLOW REVERSE SCANS;; CREATE INDEX NG_RH_NR ON NAMEDGRAPHS_NR(REVISION,HSTART)ALLOW REVERSE SCANS;; CREATE INDEX NG_UUIDR ON NAMEDGRAPHS_NR(UUID,ID)ALLOW REVERSE SCANS;; CREATE INDEX NG_COMMR ON NAMEDGRAPHS_NR(COMMITTED)ALLOW REVERSE SCANS;; ALTER TABLE LASTTRANSACTIONTIME VOLATILE;; CREATE INDEX LTT ON LASTTRANSACTIONTIME (ID,COMMITED);; CREATE INDEX LTT4 ON LASTTRANSACTIONTIME (COMMITED,ID);; ALTER TABLE TRANSACTIONTIME VOLATILE;; CREATE INDEX TID ON TRANSACTIONTIME (ID,COMMITED);; CREATE INDEX TCIU ON TRANSACTIONTIME (COMMITED,ID,URI);; CREATE INDEX TCSID ON TRANSACTIONTIME(SERVERID,COMMITED);; ALTER TABLE {0}_U VOLATILE;; CREATE UNIQUE INDEX {0}_U_IV ON {0}_U(ID) INCLUDE(VALUE)  ALLOW REVERSE SCANS;; CREATE UNIQUE INDEX {0}_U_V ON {0}_U(VALUE) INCLUDE(ID)  ALLOW REVERSE SCANS;; CREATE INDEX {0}_U_C ON {0}_U(REF DESC,ID) ALLOW REVERSE SCANS;; CREATE INDEX {0}_U_RV ON {0}_U(REF,VALUE)  ALLOW REVERSE SCANS;; ALTER TABLE {0}_B VOLATILE;; CREATE UNIQUE INDEX {0}_B_IV ON {0}_B(ID) INCLUDE(VALUE)  ALLOW REVERSE SCANS;; CREATE UNIQUE INDEX {0}_B_V ON {0}_B(VALUE) INCLUDE(ID)  ALLOW REVERSE SCANS;; CREATE INDEX {0}_B_C ON {0}_B(REF DESC,ID) ALLOW REVERSE SCANS;; CREATE INDEX {0}_B_RV ON {0}_B(REF,VALUE) ALLOW REVERSE SCANS;; ALTER TABLE {0}_L VOLATILE;; CREATE INDEX {0}_L_U ON {0}_L(VALUE)  ALLOW REVERSE SCANS;; CREATE UNIQUE INDEX {0}_L_V ON {0}_L(MODIFIER_ID,VALUE) INCLUDE(ID)  ALLOW REVERSE SCANS;; CREATE UNIQUE INDEX {0}_L_IV ON {0}_L(ID) INCLUDE(VALUE,MODIFIER_ID)  ALLOW REVERSE SCANS;; CREATE INDEX {0}_L_C ON {0}_L(REF DESC,ID) ALLOW REVERSE SCANS;; CREATE INDEX {0}_L_RV ON {0}_L(REF,MODIFIER_ID,VALUE)  ALLOW REVERSE SCANS;; ALTER TABLE {0}_LL VOLATILE;; CREATE UNIQUE INDEX {0}_LL_IV ON {0}_LL(ID) INCLUDE(MODIFIER_ID,HASH)  ALLOW REVERSE SCANS;; CREATE INDEX {0}_LL_VI ON {0}_LL(MODIFIER_ID,HASH)  ALLOW REVERSE SCANS;; CREATE INDEX {0}_LL_C ON {0}_LL(REF DESC,ID) ALLOW REVERSE SCANS;; ALTER TABLE {0}_TL VOLATILE;; CREATE INDEX {0}_TL_U ON {0}_TL(VALUE)  ALLOW REVERSE SCANS;; CREATE UNIQUE INDEX {0}_TL_V ON {0}_TL(MODIFIER_ID,VALUE) INCLUDE(ID)  ALLOW REVERSE SCANS;; CREATE UNIQUE INDEX {0}_TL_IV ON {0}_TL(ID) INCLUDE(VALUE,MODIFIER_ID)  ALLOW REVERSE SCANS;; CREATE INDEX {0}_TL_C ON {0}_TL(REF DESC,ID) ALLOW REVERSE SCANS;; CREATE INDEX {0}_TL_RV ON {0}_TL(REF,MODIFIER_ID,VALUE)   ALLOW REVERSE SCANS;; ALTER TABLE {0}_LTL VOLATILE;; CREATE UNIQUE INDEX {0}_LTL_IV ON {0}_LTL(ID) INCLUDE(MODIFIER_ID,HASH)  ALLOW REVERSE SCANS;; CREATE INDEX {0}_LTL_VI ON {0}_LTL(MODIFIER_ID,HASH)  ALLOW REVERSE SCANS;; CREATE INDEX {0}_LTL_C ON {0}_LTL(REF DESC,ID) ALLOW REVERSE SCANS;; ALTER TABLE {0}_LU VOLATILE;; CREATE UNIQUE INDEX {0}_LU_I ON {0}_LU(ID)  INCLUDE(HASH) ALLOW REVERSE SCANS;; CREATE INDEX {0}_LU_V ON {0}_LU(HASH,ID,REF)  ALLOW REVERSE SCANS;; CREATE INDEX {0}_LU_C ON {0}_LU(REF DESC,ID) ALLOW REVERSE SCANS;; CREATE UNIQUE INDEX LOCKEDID ON LOCKED_GRAPHS(ID) ALLOW REVERSE SCANS;; CREATE UNIQUE INDEX LOCKEDS ON LOCKED_GRAPHS(TRANSACTIONID,ID) ALLOW REVERSE SCANS;; CREATE INDEX {0}_UIDS_TI ON  {0}_USED_IDS(TRANSACTIONID,ID)   {1};; CREATE INDEX {0}_UIDS_IT ON  {0}_USED_IDS(ID,TRANSACTIONID)   {1};; CREATE UNIQUE INDEX QG_DSID_ID ON QUERY_GRAPHS(DSID,ID) ALLOW REVERSE SCANS;; CREATE UNIQUE INDEX {0}_DATATYPE_VI ON {0}_DATATYPE(VALUE,ID)  {1};; CREATE UNIQUE INDEX {0}_DATATYPE_IV ON {0}_DATATYPE(ID,VALUE)  {1};; CREATE UNIQUE INDEX {0}_LANGUAGE_VI ON {0}_LANGUAGE(VALUE,ID)  {1};; CREATE UNIQUE INDEX {0}_LANGUAGE_IV ON {0}_LANGUAGE(ID,VALUE)  {1} ;; 
initSequences=CREATE SEQUENCE NODE_SEQ_0 AS BIGINT START WITH 1 INCREMENT BY 1 MAXVALUE 1152921504606846975 CACHE 20000;; CREATE SEQUENCE NODE_SEQ_1 AS BIGINT START WITH 1152921504606846977 INCREMENT BY 1 MAXVALUE 2305843009213693951 CACHE 20000;; CREATE SEQUENCE NODE_SEQ_2 AS BIGINT START WITH 2305843009213693953 INCREMENT BY 1 MAXVALUE 3458764513820540927 CACHE 20000;; CREATE SEQUENCE NODE_SEQ_3 AS BIGINT START WITH 3458764513820540929 INCREMENT BY 1 MAXVALUE 4611686018427387903 CACHE 20000;; CREATE SEQUENCE NODE_SEQ_4 AS BIGINT START WITH 4611686018427387905 INCREMENT BY 1 MAXVALUE 5764607523034234879 CACHE 20000;; CREATE SEQUENCE NODE_SEQ_5 AS BIGINT START WITH 5764607523034234881 INCREMENT BY 1 MAXVALUE 6917529027641081855 CACHE 20000;; CREATE SEQUENCE NODE_SEQ_6 AS BIGINT START WITH 6917529027641081857 INCREMENT BY 1 MAXVALUE 8070450532247928831 CACHE 20000;; CREATE SEQUENCE DATATYPE_SEQ AS BIGINT START WITH 1 INCREMENT BY 1 CACHE 100;; CREATE SEQUENCE LANG_SEQ AS BIGINT START WITH 1 INCREMENT BY 1 CACHE 100;; 
...
initTablespace=CREATE  USER TEMPORARY  TABLESPACE USR_TBSP PAGESIZE 4 K  MANAGED BY AUTOMATIC STORAGE EXTENTSIZE 16 OVERHEAD 12.67 PREFETCHSIZE 16 TRANSFERRATE 0.18;; 
createTemporaryTables=DECLARE GLOBAL TEMPORARY TABLE DEFAULTGRAPHS_TMP ( ID {6} NOT NULL ) ON COMMIT PRESERVE ROWS NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; CREATE INDEX SESSION.DEFAULTGRAPHS_IDX ON SESSION.DEFAULTGRAPHS_TMP (ID) COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE NAMEDGRAPHS_TMP ( ID {6} NOT NULL ) ON COMMIT PRESERVE ROWS NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; CREATE INDEX SESSION.NAMEDGRAPHS_IDX ON SESSION.NAMEDGRAPHS_TMP (ID) COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE TEMPGRAPHS ( ID {6} NOT NULL ) ON COMMIT PRESERVE ROWS NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; CREATE INDEX SESSION.TEMPGRAPHS_IDX ON SESSION.TEMPGRAPHS (ID) COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE TEMP_COLUMNS( C0    {6}, C1    {6}, C2    {6}, C3    {6}, C4    {6}, C5    {6}, C6    {6}, C7    {6}, C8    {6}, C9    {6}, C10    {6}, C11    {6}, C12    {6}, C13    {6}, C14    {6}, C15    {6} )ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE in USR_TBSP;; DECLARE GLOBAL TEMPORARY TABLE TEMP_CONSTRAINT0( ID    {6} )ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE in USR_TBSP;; CREATE INDEX SESSION.CONSTRAINT0_IDX ON SESSION.TEMP_CONSTRAINT0 (ID) COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE TEMP_CONSTRAINT1( ID    {6} )ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE in USR_TBSP;; CREATE INDEX SESSION.CONSTRAINT1_IDX ON SESSION.TEMP_CONSTRAINT1 (ID) COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE TEMP_CONSTRAINT2( ID    {6} )ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE in USR_TBSP;; CREATE INDEX SESSION.CONSTRAINT2_IDX ON SESSION.TEMP_CONSTRAINT2 (ID) COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE TEMP_CONSTRAINT3( ID    {6} )ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE in USR_TBSP;; CREATE INDEX SESSION.CONSTRAINT3_IDX ON SESSION.TEMP_CONSTRAINT3 (ID) COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE NGR_TMP( ID     {6}, METAID   {6}, REVISION   {6}, NEW_REVISION {6}, UUID   {6} ) ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; DECLARE GLOBAL TEMPORARY TABLE STMTS_REP_TMP ( ID     {7}({4}) {3} NOT NULL, NAMEDGRAPHID  {6}, SUBJECT       {6}, PREDICATE     {6}, OBJECT        {6}, RSTART    {6}, REND    {6} ) ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; CREATE INDEX SESSION.STMTS_REP ON SESSION.STMTS_REP_TMP(REND,NAMEDGRAPHID,SUBJECT,PREDICATE,OBJECT) COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE SUBJECT_IDS_TEMP ( ID  {6} ) ON COMMIT DELETE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; DECLARE GLOBAL TEMPORARY TABLE PREDICATE_IDS_TEMP ( ID  {6} ) ON COMMIT DELETE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; DECLARE GLOBAL TEMPORARY TABLE OBJECT_IDS_TEMP ( ID  {6} ) ON COMMIT DELETE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; DECLARE GLOBAL TEMPORARY TABLE NAMEDGRAPH_IDS_TEMP ( ID  {6} ) ON COMMIT DELETE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; DECLARE GLOBAL TEMPORARY TABLE ID_TMP ( ID  {6}, ENTRYID {6}, TYPE  {5} ) ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; DECLARE GLOBAL TEMPORARY TABLE RES_TMP ( ENTRYID {6}, VALUE {7}({4}) {3} ) ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; CREATE INDEX SESSION.RES_TMP1 ON SESSION.RES_TMP(VALUE,ENTRYID);; DECLARE GLOBAL TEMPORARY TABLE LIT_TMP ( ENTRYID {6}, VALUE  {7}({4}) {3}, MODIFIER_ID {6} ) ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; CREATE INDEX SESSION.LIT_TMP1 ON SESSION.LIT_TMP(VALUE,MODIFIER_ID,ENTRYID);; DECLARE GLOBAL TEMPORARY TABLE STMTS_TMP ( OPERATION   {5} NOT NULL, ID     {7}({4}) {3} NOT NULL, STMTID    {6} NOT NULL, METADATA   {5} NOT NULL, UUID    {6} NOT NULL, NAMEDGRAPHID  {6} NOT NULL, SUBJECT       {6} NOT NULL, PREDICATE     {6} NOT NULL, OBJECT           {6} NOT NULL, REVISION   {6} NOT NULL, COMMITTED   {6} NOT NULL ) ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; CREATE INDEX SESSION.STMTS1 ON SESSION.STMTS_TMP(OPERATION,ID) ALLOW REVERSE SCANS COLLECT STATISTICS;; CREATE INDEX SESSION.STMTS2 ON SESSION.STMTS_TMP(STMTID,ID) ALLOW REVERSE SCANS COLLECT STATISTICS;; CREATE INDEX SESSION.STMTS3 ON SESSION.STMTS_TMP(STMTID,OPERATION) ALLOW REVERSE SCANS COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE STMT_ID_TMP ( ID     {7}({4}) {3} NOT NULL, STMTID    {6} NOT NULL ) ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; CREATE INDEX SESSION.STMT_ID_1 ON SESSION.STMT_ID_TMP(STMTID,ID)ALLOW REVERSE SCANS COLLECT STATISTICS;; DECLARE GLOBAL TEMPORARY TABLE REMOVE_GRAPHS_TMP ( ID     {6} NOT NULL, TYPE    {5} NOT NULL, REND    {6} NOT NULL ) ON COMMIT PRESERVE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; CREATE INDEX SESSION.RG_ID ON SESSION.REMOVE_GRAPHS_TMP(TYPE,ID,REND)ALLOW REVERSE SCANS COLLECT STATISTICS;; 
...
5To6=ALTER TABLE STATEMENTS ADD COLUMN UUID {6};; CREATE INDEX SRUUID ON STATEMENTS (UUID);; REORG TABLE STATEMENTS;; UPDATE STATEMENTS SET UUID=(SELECT DISTINCT UUID FROM NAMEDGRAPHS WHERE NAMEDGRAPHS.HEND IS NULL AND (NAMEDGRAPHS.ID=STATEMENTS.NAMEDGRAPHID OR NAMEDGRAPHS.METAID=STATEMENTS.NAMEDGRAPHID));; ALTER TABLE STATEMENTS ALTER COLUMN UUID SET NOT NULL;; REORG TABLE STATEMENTS;; 
5To6more=
6To7=DECLARE GLOBAL TEMPORARY TABLE SERVER_TMP ( ID                  {6} NOT NULL, VERSION     {6} NOT NULL, INITIALIZED    {6} ) ON COMMIT DELETE ROWS  NOT LOGGED ON ROLLBACK DELETE ROWS WITH REPLACE IN USR_TBSP;; INSERT INTO SESSION.SERVER_TMP(ID,VERSION,INITIALIZED) SELECT ID,VERSION,INITIALIZED FROM SERVER;; DROP TABLE SERVER;; CREATE TABLE SERVER ( ID                  {6} NOT NULL, VERSION     {6} NOT NULL, INITIALIZED    {6} );; CREATE INDEX SERVERIVL ON SERVER (ID,VERSION,INITIALIZED);; CREATE INDEX SERVERIL ON SERVER(ID,INITIALIZED);; CREATE INDEX SERVERL ON SERVER(INITIALIZED);; INSERT INTO SERVER(ID,VERSION,INITIALIZED) SELECT ID,VERSION,INITIALIZED FROM SESSION.SERVER_TMP;; 
6To7more=
7To8=ALTER TABLE {0}_DATATYPE ALTER COLUMN ID DROP IDENTITY;; ALTER TABLE {0}_LANGUAGE ALTER COLUMN ID DROP IDENTITY;; CREATE SEQUENCE DATATYPE_SEQ AS BIGINT START WITH 1 INCREMENT BY 1 CACHE 100;; CREATE SEQUENCE LANG_SEQ AS BIGINT START WITH 1 INCREMENT BY 1 CACHE 100;; 
7To8more=
...
InsertStatements.commitRemoveStatements=UPDATE STATEMENTS SET COMMITTED=?, REND=(SELECT ST.REVISION FROM {0}STMTS_TMP ST WHERE ST.OPERATION=0 AND ST.ID=STATEMENTS.ID) WHERE COMMITTED=0 AND REND IS NULL AND ID IN (SELECT ST.ID FROM {0}STMTS_TMP ST WHERE ST.OPERATION=0)
...
InsertStatements.commitRemoveStatementsRange=UPDATE STATEMENTS SET COMMITTED=?, REND=(SELECT ST.REVISION FROM {0}STMTS_TMP ST WHERE ST.OPERATION=0 AND ST.ID=STATEMENTS.ID) WHERE COMMITTED=0 AND REND IS NULL AND ID IN (SELECT ST.ID FROM {0}STMTS_TMP ST WHERE ST.STMTID >= ? AND ST.STMTID < ? AND ST.OPERATION=0)
...
InsertStatements.commitTransactionStatementsRange=UPDATE STATEMENTS SET COMMITTED=0 WHERE COMMITTED=? AND STATEMENTS.ID IN (SELECT ST.ID FROM {0}STMT_ID_TMP ST WHERE ST.STMTID>=? AND ST.STMTID < ? )
...
InsertStatements.commitRemoveStatementsNR=UPDATE STATEMENTS_NR SET COMMITTED=? WHERE ID IN( SELECT ST.ID FROM {0}STMTS_TMP ST WHERE ST.OPERATION=0 )
...
InsertStatements.commitRemoveStatementsNRRange=UPDATE STATEMENTS_NR SET COMMITTED=? WHERE ID IN( SELECT ST.ID FROM {0}STMTS_TMP ST WHERE ST.STMTID >= ? AND ST.STMTID < ? AND ST.OPERATION=0)
...
InsertStatements.commitTransactionAddStatementsNRRange=UPDATE STATEMENTS_NR SET COMMITTED=0 WHERE COMMITTED=? AND STATEMENTS_NR.ID IN (SELECT ST.ID FROM {0}STMT_ID_TMP ST WHERE ST.STMTID>=? AND ST.STMTID < ?)
...
LastTransaction.selectCurrentTimestamp=SELECT CURRENT TIMESTAMP as NEWTIME,COMMITED FROM LASTTRANSACTIONTIME
...
Server.stats=CALL SYSPROC.ADMIN_CMD (''RUNSTATS ON TABLE DB2INST1.{0} ON KEY COLUMNS and INDEXES ALL'')

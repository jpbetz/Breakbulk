...
CREATE INDEX SRUUID ON STATEMENTS (UUID,COMMITTED,REND,RSTART);
CREATE INDEX SRHS ON STATEMENTS (SUBJECT,PREDICATE);
CREATE INDEX SRHPO ON STATEMENTS (PREDICATE,OBJECT);
CREATE INDEX SRHO ON STATEMENTS (OBJECT);
CREATE INDEX SRHC ON STATEMENTS (COMMITTED,ID,REND);
CREATE INDEX SRIE ON STATEMENTS (ID,REND);
CREATE INDEX SNG ON STATEMENTS (COMMITTED,NAMEDGRAPHID,REND) ;
...
CREATE INDEX NG_ITRM ON NAMEDGRAPHS (ID,COMMITTED,HEND,HSTART,REVISION,METAID);
CREATE INDEX NG_UUDI ON NAMEDGRAPHS (COMMITTED,ID,HEND,UUID);
...
CREATE INDEX NG_C_NR ON NAMEDGRAPHS (COMMITTED,ID);
...
CREATE INDEX {0}_U_RV ON {0}_U(REF,VALUE,ID);
...
CREATE INDEX {0}_L_RV ON {0}_L(REF,MODIFIER_ID,VALUE,ID);
...
CREATE INDEX {0}_TL_RV ON {0}_TL(REF,MODIFIER_ID,VALUE,ID);
...
CREATE INDEX {0}_B_RV ON {0}_B(REF,VALUE,ID);

...
/**
 * Implementation of {@link org.openanzo.ontologies.foaf.PersonalProfileDocument}
 ...
 * <br>
 */
public class PersonalProfileDocumentImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.foaf.PersonalProfileDocument {
	...
	PersonalProfileDocumentImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static PersonalProfileDocumentImpl getPersonalProfileDocument(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, PersonalProfileDocument.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new PersonalProfileDocumentImpl(resource, namedGraphUri, dataset);
	}
	    
	static PersonalProfileDocumentImpl createPersonalProfileDocument(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		PersonalProfileDocumentImpl impl = new PersonalProfileDocumentImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, PersonalProfileDocument.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, PersonalProfileDocument.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.ontologies.foaf.PersonalProfileDocument.TYPE, _graph.getNamedGraphUri()));
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionSha1 = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/sha1 properties in PersonalProfileDocument model not a Literal",value);
				}
			}
	};
...
// generating for property: http://xmlns.com/foaf/0.1/primaryTopic
	...
	public org.openanzo.rdf.jastor.Thing getPrimaryTopic(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": primaryTopic getProperty() in org.openanzo.ontologies.foaf.PersonalProfileDocument model not Resource", statement.getObject());
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionDnaChecksum = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/dnaChecksum properties in PersonalProfileDocument model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionNick = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/nick properties in PersonalProfileDocument model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionTitle = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/title properties in PersonalProfileDocument model not a Literal",value);
				}
			}
	};
...
/**
	...
	protected java.util.concurrent.CopyOnWriteArraySet<PersonalProfileDocumentListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<PersonalProfileDocumentListener>();
	...
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
    	...
    	PersonalProfileDocumentListener list = (PersonalProfileDocumentListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(sha1Property)) {				
				...
				for(PersonalProfileDocumentListener listener : listeners){
					listener.sha1Added(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(primaryTopicProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;				
				for(PersonalProfileDocumentListener listener : listeners){
					listener.primaryTopicChanged(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this);
				}			
			}
			if (statement.getPredicate().equals(topicProperty)) {
				...
				if (_topic != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.topicAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_topic);
					}
				}			
			}
			if (statement.getPredicate().equals(depictionProperty)) {
				...
				if (_depiction != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.depictionAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_depiction);
					}
				}			
			}
			if (statement.getPredicate().equals(fundedByProperty)) {
				...
				if (_fundedBy != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.fundedByAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_fundedBy);
					}
				}			
			}
			if (statement.getPredicate().equals(homepageProperty)) {
				...
				if (_homepage != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.homepageAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_homepage);
					}
				}			
			}
			...
			if (statement.getPredicate().equals(logoProperty)) {
				...
				if (_logo != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.logoAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_logo);
					}
				}			
			}
			if (statement.getPredicate().equals(makerProperty)) {
				...
				if (_maker != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.makerAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_maker);
					}
				}			
			}
			if (statement.getPredicate().equals(pageProperty)) {
				...
				if (_page != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.pageAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_page);
					}
				}			
			}
			if (statement.getPredicate().equals(themeProperty)) {
				...
				if (_theme != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.themeAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_theme);
					}
				}			
			}
			if (statement.getPredicate().equals(dnaChecksumProperty)) {				
				...
				for(PersonalProfileDocumentListener listener : listeners){
					listener.dnaChecksumAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(nickProperty)) {				
				...
				for(PersonalProfileDocumentListener listener : listeners){
					listener.nickAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(titleProperty)) {				
				...
				for(PersonalProfileDocumentListener listener : listeners){
					listener.titleAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(phoneProperty)) {
				...
				if (_phone != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.phoneAdded(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_phone);
					}
				}			
			}
		}}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(sha1Property)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(PersonalProfileDocumentListener listener:listeners){
					listener.sha1Removed(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(primaryTopicProperty)) {
			...
			if (statement.getPredicate().equals(topicProperty)) {
				...
				if (_topic != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.topicRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_topic);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(depictionProperty)) {
				...
				if (_depiction != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.depictionRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_depiction);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(fundedByProperty)) {
				...
				if (_fundedBy != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.fundedByRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_fundedBy);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(homepageProperty)) {
				...
				if (_homepage != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.homepageRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_homepage);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(logoProperty)) {
				...
				if (_logo != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.logoRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_logo);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(makerProperty)) {
				...
				if (_maker != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.makerRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_maker);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(pageProperty)) {
				...
				if (_page != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.pageRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_page);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(themeProperty)) {
				...
				if (_theme != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.themeRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_theme);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(dnaChecksumProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(PersonalProfileDocumentListener listener:listeners){
					listener.dnaChecksumRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(nickProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(PersonalProfileDocumentListener listener:listeners){
					listener.nickRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(titleProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(PersonalProfileDocumentListener listener:listeners){
					listener.titleRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(phoneProperty)) {
				...
				if (_phone != null) {
					for(PersonalProfileDocumentListener listener : listeners){
						listener.phoneRemoved(org.openanzo.ontologies.foaf.PersonalProfileDocumentImpl.this,_phone);
					}
				}
				return;
			}

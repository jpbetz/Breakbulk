...
/**
 * Implementation of {@link org.openanzo.ontologies.foaf.OnlineChatAccount}
 ...
 * <br>
 */
public class OnlineChatAccountImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.foaf.OnlineChatAccount {
	...
	OnlineChatAccountImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static OnlineChatAccountImpl getOnlineChatAccount(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, OnlineChatAccount.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new OnlineChatAccountImpl(resource, namedGraphUri, dataset);
	}
	    
	static OnlineChatAccountImpl createOnlineChatAccount(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		OnlineChatAccountImpl impl = new OnlineChatAccountImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, OnlineChatAccount.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, OnlineChatAccount.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.ontologies.foaf.OnlineChatAccount.TYPE, _graph.getNamedGraphUri()));
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionAccountName = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/accountName properties in OnlineChatAccount model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionDnaChecksum = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/dnaChecksum properties in OnlineChatAccount model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionNick = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/nick properties in OnlineChatAccount model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionTitle = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/title properties in OnlineChatAccount model not a Literal",value);
				}
			}
	};
...
/**
	...
	protected java.util.concurrent.CopyOnWriteArraySet<OnlineChatAccountListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<OnlineChatAccountListener>();
	...
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
    	...
    	OnlineChatAccountListener list = (OnlineChatAccountListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(accountNameProperty)) {				
				...
				for(OnlineChatAccountListener listener : listeners){
					listener.accountNameAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(accountServiceHomepageProperty)) {
				...
				if (_accountServiceHomepage != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.accountServiceHomepageAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_accountServiceHomepage);
					}
				}			
			}
			if (statement.getPredicate().equals(depictionProperty)) {
				...
				if (_depiction != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.depictionAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_depiction);
					}
				}			
			}
			if (statement.getPredicate().equals(fundedByProperty)) {
				...
				if (_fundedBy != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.fundedByAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_fundedBy);
					}
				}			
			}
			if (statement.getPredicate().equals(homepageProperty)) {
				...
				if (_homepage != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.homepageAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_homepage);
					}
				}			
			}
			...
			if (statement.getPredicate().equals(logoProperty)) {
				...
				if (_logo != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.logoAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_logo);
					}
				}			
			}
			if (statement.getPredicate().equals(makerProperty)) {
				...
				if (_maker != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.makerAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_maker);
					}
				}			
			}
			if (statement.getPredicate().equals(pageProperty)) {
				...
				if (_page != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.pageAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_page);
					}
				}			
			}
			if (statement.getPredicate().equals(themeProperty)) {
				...
				if (_theme != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.themeAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_theme);
					}
				}			
			}
			if (statement.getPredicate().equals(dnaChecksumProperty)) {				
				...
				for(OnlineChatAccountListener listener : listeners){
					listener.dnaChecksumAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(nickProperty)) {				
				...
				for(OnlineChatAccountListener listener : listeners){
					listener.nickAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(titleProperty)) {				
				...
				for(OnlineChatAccountListener listener : listeners){
					listener.titleAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(phoneProperty)) {
				...
				if (_phone != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.phoneAdded(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_phone);
					}
				}			
			}
		}}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(accountNameProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(OnlineChatAccountListener listener:listeners){
					listener.accountNameRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(accountServiceHomepageProperty)) {
				...
				if (_accountServiceHomepage != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.accountServiceHomepageRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_accountServiceHomepage);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(depictionProperty)) {
				...
				if (_depiction != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.depictionRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_depiction);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(fundedByProperty)) {
				...
				if (_fundedBy != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.fundedByRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_fundedBy);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(homepageProperty)) {
				...
				if (_homepage != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.homepageRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_homepage);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(logoProperty)) {
				...
				if (_logo != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.logoRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_logo);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(makerProperty)) {
				...
				if (_maker != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.makerRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_maker);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(pageProperty)) {
				...
				if (_page != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.pageRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_page);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(themeProperty)) {
				...
				if (_theme != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.themeRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_theme);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(dnaChecksumProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(OnlineChatAccountListener listener:listeners){
					listener.dnaChecksumRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(nickProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(OnlineChatAccountListener listener:listeners){
					listener.nickRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(titleProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(OnlineChatAccountListener listener:listeners){
					listener.titleRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(phoneProperty)) {
				...
				if (_phone != null) {
					for(OnlineChatAccountListener listener : listeners){
						listener.phoneRemoved(org.openanzo.ontologies.foaf.OnlineChatAccountImpl.this,_phone);
					}
				}
				return;
			}

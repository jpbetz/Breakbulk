...
/**
 * Implementation of {@link org.openanzo.ontologies.foaf.Document}
 ...
 * <br>
 */
public class DocumentImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.foaf.Document {
	...
	DocumentImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static DocumentImpl getDocument(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, Document.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new DocumentImpl(resource, namedGraphUri, dataset);
	}
	    
	static DocumentImpl createDocument(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		DocumentImpl impl = new DocumentImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, Document.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, Document.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionSha1 = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/sha1 properties in Document model not a Literal",value);
				}
			}
	};
...
// generating for property: http://xmlns.com/foaf/0.1/primaryTopic
	...
	public org.openanzo.rdf.jastor.Thing getPrimaryTopic(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": primaryTopic getProperty() in org.openanzo.ontologies.foaf.Document model not Resource", statement.getObject());
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionDnaChecksum = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/dnaChecksum properties in Document model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionNick = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/nick properties in Document model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionTitle = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/title properties in Document model not a Literal",value);
				}
			}
	};
...
/**
	...
	protected java.util.concurrent.CopyOnWriteArraySet<DocumentListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<DocumentListener>();
	...
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
    	...
    	DocumentListener list = (DocumentListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(sha1Property)) {				
				...
				for(DocumentListener listener : listeners){
					listener.sha1Added(org.openanzo.ontologies.foaf.DocumentImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(primaryTopicProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;				
				for(DocumentListener listener : listeners){
					listener.primaryTopicChanged(org.openanzo.ontologies.foaf.DocumentImpl.this);
				}			
			}
			if (statement.getPredicate().equals(topicProperty)) {
				...
				if (_topic != null) {
					for(DocumentListener listener : listeners){
						listener.topicAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,_topic);
					}
				}			
			}
			if (statement.getPredicate().equals(depictionProperty)) {
				...
				if (_depiction != null) {
					for(DocumentListener listener : listeners){
						listener.depictionAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,_depiction);
					}
				}			
			}
			if (statement.getPredicate().equals(fundedByProperty)) {
				...
				if (_fundedBy != null) {
					for(DocumentListener listener : listeners){
						listener.fundedByAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,_fundedBy);
					}
				}			
			}
			if (statement.getPredicate().equals(homepageProperty)) {
				...
				if (_homepage != null) {
					for(DocumentListener listener : listeners){
						listener.homepageAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,_homepage);
					}
				}			
			}
			...
			if (statement.getPredicate().equals(logoProperty)) {
				...
				if (_logo != null) {
					for(DocumentListener listener : listeners){
						listener.logoAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,_logo);
					}
				}			
			}
			if (statement.getPredicate().equals(makerProperty)) {
				...
				if (_maker != null) {
					for(DocumentListener listener : listeners){
						listener.makerAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,_maker);
					}
				}			
			}
			if (statement.getPredicate().equals(pageProperty)) {
				...
				if (_page != null) {
					for(DocumentListener listener : listeners){
						listener.pageAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,_page);
					}
				}			
			}
			if (statement.getPredicate().equals(themeProperty)) {
				...
				if (_theme != null) {
					for(DocumentListener listener : listeners){
						listener.themeAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,_theme);
					}
				}			
			}
			if (statement.getPredicate().equals(dnaChecksumProperty)) {				
				...
				for(DocumentListener listener : listeners){
					listener.dnaChecksumAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(nickProperty)) {				
				...
				for(DocumentListener listener : listeners){
					listener.nickAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(titleProperty)) {				
				...
				for(DocumentListener listener : listeners){
					listener.titleAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(phoneProperty)) {
				...
				if (_phone != null) {
					for(DocumentListener listener : listeners){
						listener.phoneAdded(org.openanzo.ontologies.foaf.DocumentImpl.this,_phone);
					}
				}			
			}
		}}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(sha1Property)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(DocumentListener listener:listeners){
					listener.sha1Removed(org.openanzo.ontologies.foaf.DocumentImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(primaryTopicProperty)) {
			...
			if (statement.getPredicate().equals(topicProperty)) {
				...
				if (_topic != null) {
					for(DocumentListener listener : listeners){
						listener.topicRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,_topic);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(depictionProperty)) {
				...
				if (_depiction != null) {
					for(DocumentListener listener : listeners){
						listener.depictionRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,_depiction);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(fundedByProperty)) {
				...
				if (_fundedBy != null) {
					for(DocumentListener listener : listeners){
						listener.fundedByRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,_fundedBy);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(homepageProperty)) {
				...
				if (_homepage != null) {
					for(DocumentListener listener : listeners){
						listener.homepageRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,_homepage);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(logoProperty)) {
				...
				if (_logo != null) {
					for(DocumentListener listener : listeners){
						listener.logoRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,_logo);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(makerProperty)) {
				...
				if (_maker != null) {
					for(DocumentListener listener : listeners){
						listener.makerRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,_maker);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(pageProperty)) {
				...
				if (_page != null) {
					for(DocumentListener listener : listeners){
						listener.pageRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,_page);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(themeProperty)) {
				...
				if (_theme != null) {
					for(DocumentListener listener : listeners){
						listener.themeRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,_theme);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(dnaChecksumProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(DocumentListener listener:listeners){
					listener.dnaChecksumRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(nickProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(DocumentListener listener:listeners){
					listener.nickRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(titleProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(DocumentListener listener:listeners){
					listener.titleRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(phoneProperty)) {
				...
				if (_phone != null) {
					for(DocumentListener listener : listeners){
						listener.phoneRemoved(org.openanzo.ontologies.foaf.DocumentImpl.this,_phone);
					}
				}
				return;
			}

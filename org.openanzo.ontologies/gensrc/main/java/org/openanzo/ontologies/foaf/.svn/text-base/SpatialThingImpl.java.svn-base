...
/**
 * Implementation of {@link org.openanzo.ontologies.foaf.SpatialThing}
 ...
 * <br>
 */
public class SpatialThingImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.foaf.SpatialThing {
	...
	SpatialThingImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static SpatialThingImpl getSpatialThing(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, SpatialThing.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new SpatialThingImpl(resource, namedGraphUri, dataset);
	}
	    
	static SpatialThingImpl createSpatialThing(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		SpatialThingImpl impl = new SpatialThingImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, SpatialThing.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, SpatialThing.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionDnaChecksum = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/dnaChecksum properties in SpatialThing model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionNick = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/nick properties in SpatialThing model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal> propertyCollectionTitle = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.Literal>() {
		public org.openanzo.rdf.Literal getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://xmlns.com/foaf/0.1/title properties in SpatialThing model not a Literal",value);
				}
			}
	};
...
/**
	...
	protected java.util.concurrent.CopyOnWriteArraySet<SpatialThingListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<SpatialThingListener>();
	...
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
    	...
    	SpatialThingListener list = (SpatialThingListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(based__nearProperty)) {
				...
				if (_based__near != null) {
					for(SpatialThingListener listener : listeners){
						listener.based__nearAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_based__near);
					}
				}			
			}
			if (statement.getPredicate().equals(depictionProperty)) {
				...
				if (_depiction != null) {
					for(SpatialThingListener listener : listeners){
						listener.depictionAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_depiction);
					}
				}			
			}
			if (statement.getPredicate().equals(fundedByProperty)) {
				...
				if (_fundedBy != null) {
					for(SpatialThingListener listener : listeners){
						listener.fundedByAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_fundedBy);
					}
				}			
			}
			if (statement.getPredicate().equals(homepageProperty)) {
				...
				if (_homepage != null) {
					for(SpatialThingListener listener : listeners){
						listener.homepageAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_homepage);
					}
				}			
			}
			...
			if (statement.getPredicate().equals(logoProperty)) {
				...
				if (_logo != null) {
					for(SpatialThingListener listener : listeners){
						listener.logoAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_logo);
					}
				}			
			}
			if (statement.getPredicate().equals(makerProperty)) {
				...
				if (_maker != null) {
					for(SpatialThingListener listener : listeners){
						listener.makerAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_maker);
					}
				}			
			}
			if (statement.getPredicate().equals(pageProperty)) {
				...
				if (_page != null) {
					for(SpatialThingListener listener : listeners){
						listener.pageAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_page);
					}
				}			
			}
			if (statement.getPredicate().equals(themeProperty)) {
				...
				if (_theme != null) {
					for(SpatialThingListener listener : listeners){
						listener.themeAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_theme);
					}
				}			
			}
			if (statement.getPredicate().equals(dnaChecksumProperty)) {				
				...
				for(SpatialThingListener listener : listeners){
					listener.dnaChecksumAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(nickProperty)) {				
				...
				for(SpatialThingListener listener : listeners){
					listener.nickAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(titleProperty)) {				
				...
				for(SpatialThingListener listener : listeners){
					listener.titleAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,literal);
				}			
			}
			if (statement.getPredicate().equals(phoneProperty)) {
				...
				if (_phone != null) {
					for(SpatialThingListener listener : listeners){
						listener.phoneAdded(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_phone);
					}
				}			
			}
		}}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(based__nearProperty)) {
				...
				if (_based__near != null) {
					for(SpatialThingListener listener : listeners){
						listener.based__nearRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_based__near);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(depictionProperty)) {
				...
				if (_depiction != null) {
					for(SpatialThingListener listener : listeners){
						listener.depictionRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_depiction);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(fundedByProperty)) {
				...
				if (_fundedBy != null) {
					for(SpatialThingListener listener : listeners){
						listener.fundedByRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_fundedBy);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(homepageProperty)) {
				...
				if (_homepage != null) {
					for(SpatialThingListener listener : listeners){
						listener.homepageRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_homepage);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(logoProperty)) {
				...
				if (_logo != null) {
					for(SpatialThingListener listener : listeners){
						listener.logoRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_logo);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(makerProperty)) {
				...
				if (_maker != null) {
					for(SpatialThingListener listener : listeners){
						listener.makerRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_maker);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(pageProperty)) {
				...
				if (_page != null) {
					for(SpatialThingListener listener : listeners){
						listener.pageRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_page);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(themeProperty)) {
				...
				if (_theme != null) {
					for(SpatialThingListener listener : listeners){
						listener.themeRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_theme);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(dnaChecksumProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(SpatialThingListener listener:listeners){
					listener.dnaChecksumRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(nickProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(SpatialThingListener listener:listeners){
					listener.nickRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(titleProperty)) {	
				...
				org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
				for(SpatialThingListener listener:listeners){
					listener.titleRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,literal);
				}
				return;
			}
			if (statement.getPredicate().equals(phoneProperty)) {
				...
				if (_phone != null) {
					for(SpatialThingListener listener : listeners){
						listener.phoneRemoved(org.openanzo.ontologies.foaf.SpatialThingImpl.this,_phone);
					}
				}
				return;
			}

...
/**
 * Implementation of {@link org.openanzo.ontologies.openanzo.DatasetTracker}
 ...
 * <br>
 */
public class DatasetTrackerImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.openanzo.DatasetTracker {
	...
	protected static final org.openanzo.rdf.URI namedDatasetProperty = org.openanzo.rdf.jastor.ThingFactory.valueFactory.createURI("http://openanzo.org/ontologies/2008/07/Anzo#namedDataset");

	DatasetTrackerImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static DatasetTrackerImpl getDatasetTracker(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, DatasetTracker.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new DatasetTrackerImpl(resource, namedGraphUri, dataset);
	}
	    
	static DatasetTrackerImpl createDatasetTracker(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		DatasetTrackerImpl impl = new DatasetTrackerImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, DatasetTracker.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, DatasetTracker.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource, namedDatasetProperty, null, _graph.getNamedGraphUri()));
		
		
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.ontologies.openanzo.DatasetTracker.TYPE, _graph.getNamedGraphUri()));
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#includeMetadataGraphs
	public java.lang.Boolean getIncludeMetadataGraphs(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": includeMetadataGraphs getProperty() in org.openanzo.ontologies.openanzo.DatasetTracker model not Literal", statement.getObject());
		...
		if (!(obj instanceof java.lang.Boolean))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal includeMetadataGraphs in DatasetTracker is not of type java.lang.Boolean", literal);
...
/**
	...
	public void clearNamedDataset(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException{
		_dataset.remove(_resource, namedDatasetProperty, null,(includeEntireDataset)?null:_graph.getNamedGraphUri());
	}
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#namedDataset

// generating range: http://jastor.adtech.ibm.com/defaultRange

	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.ontologies.openanzo.NamedGraph> propertyCollectionNamedDataset = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.ontologies.openanzo.NamedGraph>() {
		public org.openanzo.ontologies.openanzo.NamedGraph getPropertyValue(org.openanzo.rdf.Value resource) {
			try {
				return org.openanzo.ontologies.openanzo.AnzoFactory.getNamedGraph((org.openanzo.rdf.Resource)resource,_graph.getNamedGraphUri(),dataset());
			} catch (org.openanzo.rdf.jastor.JastorException e) {
	...
	public java.util.Collection<org.openanzo.ontologies.openanzo.NamedGraph> getNamedDataset(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		return propertyCollectionNamedDataset.getPropertyCollection(_dataset, _graph, _resource,namedDatasetProperty, org.openanzo.rdf.MemURI.create("http://openanzo.org/ontologies/2008/07/Anzo#NamedGraph"), includeEntireDataset);
	}
	...
	public java.util.Collection<org.openanzo.ontologies.openanzo.NamedGraph> getNamedDataset() throws org.openanzo.rdf.jastor.JastorException {
		return getNamedDataset(false);
	}

/**
     * 
     * @param namedDataset value to add
     * @throws org.openanzo.rdf.jastor.JastorException
     */
	public void addNamedDataset(org.openanzo.ontologies.openanzo.NamedGraph namedDataset) throws org.openanzo.rdf.jastor.JastorException {
		_dataset.add(_resource, namedDatasetProperty,namedDataset.resource(),_graph.getNamedGraphUri());
	}
	...
	public org.openanzo.ontologies.openanzo.NamedGraph addNamedDataset() throws org.openanzo.rdf.jastor.JastorException {
		org.openanzo.ontologies.openanzo.NamedGraph namedDataset = org.openanzo.ontologies.openanzo.AnzoFactory.createNamedGraph(org.openanzo.rdf.jastor.ThingFactory.valueFactory.createBNode(),_graph.getNamedGraphUri(),_dataset);
		_dataset.add(_resource, namedDatasetProperty,namedDataset.resource(),_graph.getNamedGraphUri());
		return namedDataset;
	}
	...
	public org.openanzo.ontologies.openanzo.NamedGraph addNamedDataset(org.openanzo.rdf.Resource resource) throws org.openanzo.rdf.jastor.JastorException {
		org.openanzo.ontologies.openanzo.NamedGraph namedDataset = org.openanzo.ontologies.openanzo.AnzoFactory.getNamedGraph(resource,_graph.getNamedGraphUri(),_dataset);
		_dataset.add(_resource, namedDatasetProperty,namedDataset.resource(),_graph.getNamedGraphUri());
		return namedDataset;
	}
	...
	/**
	 * Remove object
	 * @param namedDataset object to remove
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
	public void removeNamedDataset(org.openanzo.ontologies.openanzo.NamedGraph namedDataset) throws org.openanzo.rdf.jastor.JastorException {
		if (!_dataset.contains(_resource, namedDatasetProperty, namedDataset.resource(),_graph.getNamedGraphUri()))
			return;
		_dataset.remove(_resource, namedDatasetProperty, namedDataset.resource(),_graph.getNamedGraphUri());
	}
	 ...
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
	public void removeNamedDataset(org.openanzo.rdf.Resource resource) throws org.openanzo.rdf.jastor.JastorException {
		if (!_dataset.contains(_resource, namedDatasetProperty, resource,_graph.getNamedGraphUri()))
			return;
		_dataset.remove(_resource, namedDatasetProperty, resource,_graph.getNamedGraphUri());
	}
  


	protected java.util.concurrent.CopyOnWriteArraySet<DatasetTrackerListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<DatasetTrackerListener>();
	
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
		if (!(listener instanceof DatasetTrackerListener)) {
			throw new org.openanzo.rdf.jastor.JastorException("Listener class not of proper type");
		}
		if(listeners.size()==0){
    		_dataset.registerListener(_listener);
    	}
    	DatasetTrackerListener list = (DatasetTrackerListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(includeMetadataGraphsProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(DatasetTrackerListener listener : listeners){
					listener.includeMetadataGraphsChanged(org.openanzo.ontologies.openanzo.DatasetTrackerImpl.this);
				}			
			}
			if (statement.getPredicate().equals(defaultGraphProperty)) {
				...
				if (_defaultGraph != null) {
					for(DatasetTrackerListener listener : listeners){
						listener.defaultGraphAdded(org.openanzo.ontologies.openanzo.DatasetTrackerImpl.this,_defaultGraph);
					}
				}			
			}
			if (statement.getPredicate().equals(defaultNamedGraphProperty)) {
				...
				if (_defaultNamedGraph != null) {
					for(DatasetTrackerListener listener : listeners){
						listener.defaultNamedGraphAdded(org.openanzo.ontologies.openanzo.DatasetTrackerImpl.this,_defaultNamedGraph);
					}
				}			
			}
			if (statement.getPredicate().equals(namedGraphProperty)) {
				...
				if (_namedGraph != null) {
					for(DatasetTrackerListener listener : listeners){
						listener.namedGraphAdded(org.openanzo.ontologies.openanzo.DatasetTrackerImpl.this,_namedGraph);
					}
				}			
			}
			if (statement.getPredicate().equals(namedDatasetProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;
				org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
				org.openanzo.ontologies.openanzo.NamedGraph _namedDataset = org.openanzo.ontologies.openanzo.AnzoFactory.getNamedGraph(resource,_graph.getNamedGraphUri(),dataset());
				if (_namedDataset != null) {
					for(DatasetTrackerListener listener : listeners){
						listener.namedDatasetAdded(org.openanzo.ontologies.openanzo.DatasetTrackerImpl.this,_namedDataset);
					}
				}			
			}
		}}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(defaultGraphProperty)) {
				...
				if (_defaultGraph != null) {
					for(DatasetTrackerListener listener : listeners){
						listener.defaultGraphRemoved(org.openanzo.ontologies.openanzo.DatasetTrackerImpl.this,_defaultGraph);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(defaultNamedGraphProperty)) {
				...
				if (_defaultNamedGraph != null) {
					for(DatasetTrackerListener listener : listeners){
						listener.defaultNamedGraphRemoved(org.openanzo.ontologies.openanzo.DatasetTrackerImpl.this,_defaultNamedGraph);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(namedGraphProperty)) {
				...
				if (_namedGraph != null) {
					for(DatasetTrackerListener listener : listeners){
						listener.namedGraphRemoved(org.openanzo.ontologies.openanzo.DatasetTrackerImpl.this,_namedGraph);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(namedDatasetProperty)) {
				...
				if (_namedDataset != null) {
					for(DatasetTrackerListener listener : listeners){
						listener.namedDatasetRemoved(org.openanzo.ontologies.openanzo.DatasetTrackerImpl.this,_namedDataset);
					}
				}
				return;
			}

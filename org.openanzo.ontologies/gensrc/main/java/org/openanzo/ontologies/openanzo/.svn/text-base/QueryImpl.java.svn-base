...
/**
 * Implementation of {@link org.openanzo.ontologies.openanzo.Query}
 ...
 * <br>
 */
public class QueryImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.openanzo.Query {
	private ThingStatementListener _listener = null;

	protected static final org.openanzo.rdf.URI queryStringProperty = org.openanzo.rdf.jastor.ThingFactory.valueFactory.createURI("http://openanzo.org/ontologies/2008/07/Anzo#queryString");

	QueryImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static QueryImpl getQuery(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, Query.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new QueryImpl(resource, namedGraphUri, dataset);
	}
	    
	static QueryImpl createQuery(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		QueryImpl impl = new QueryImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, Query.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, Query.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.ontologies.openanzo.Query.TYPE, _graph.getNamedGraphUri()));
		return list;
	}
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#queryString
	public java.lang.String getQueryString(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": queryString getProperty() in org.openanzo.ontologies.openanzo.Query model not Literal", statement.getObject());
		...
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal queryString in Query is not of type java.lang.String", literal);
	...
	protected java.util.concurrent.CopyOnWriteArraySet<QueryListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<QueryListener>();
	...
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
    	...
    	QueryListener list = (QueryListener)listener;
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(queryStringProperty)) {				
				...
				for(QueryListener listener : listeners){
					listener.queryStringChanged(org.openanzo.ontologies.openanzo.QueryImpl.this);
				}			
			}
		}}
		}

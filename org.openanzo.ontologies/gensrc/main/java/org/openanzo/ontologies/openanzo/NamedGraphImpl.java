...
/**
 * Implementation of {@link org.openanzo.ontologies.openanzo.NamedGraph}
 ...
 * <br>
 */
public class NamedGraphImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.openanzo.NamedGraph {
	...
	NamedGraphImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static NamedGraphImpl getNamedGraph(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, NamedGraph.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new NamedGraphImpl(resource, namedGraphUri, dataset);
	}
	    
	static NamedGraphImpl createNamedGraph(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		NamedGraphImpl impl = new NamedGraphImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, NamedGraph.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, NamedGraph.TYPE, namedGraphUri);
		impl.addSuperTypes();
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#created
	public javax.xml.datatype.XMLGregorianCalendar getCreated(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": created getProperty() in org.openanzo.ontologies.openanzo.NamedGraph model not Literal", statement.getObject());
		...
		if (!(obj instanceof javax.xml.datatype.XMLGregorianCalendar))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal created in NamedGraph is not of type javax.xml.datatype.XMLGregorianCalendar", literal);
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#hasMetadataGraph
	public org.openanzo.rdf.URI getHasMetadataGraph(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!(statement.getObject() instanceof org.openanzo.rdf.URI))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": hasMetadataGraph getProperty() in org.openanzo.ontologies.openanzo.NamedGraph model not URI", statement.getObject());
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#modified
	public javax.xml.datatype.XMLGregorianCalendar getModified(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": modified getProperty() in org.openanzo.ontologies.openanzo.NamedGraph model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#dateTime");
		if (!(obj instanceof javax.xml.datatype.XMLGregorianCalendar))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal modified in NamedGraph is not of type javax.xml.datatype.XMLGregorianCalendar", literal);
		return (javax.xml.datatype.XMLGregorianCalendar)obj;
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#persisted
	public java.lang.Boolean getPersisted(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": persisted getProperty() in org.openanzo.ontologies.openanzo.NamedGraph model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#boolean");
		if (!(obj instanceof java.lang.Boolean))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal persisted in NamedGraph is not of type java.lang.Boolean", literal);
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#revision
	public java.lang.Long getRevision(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": revision getProperty() in org.openanzo.ontologies.openanzo.NamedGraph model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#long");
		if (!(obj instanceof java.lang.Long))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal revision in NamedGraph is not of type java.lang.Long", literal);
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#revisioned
	public java.lang.Boolean getRevisioned(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": revisioned getProperty() in org.openanzo.ontologies.openanzo.NamedGraph model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#boolean");
		if (!(obj instanceof java.lang.Boolean))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal revisioned in NamedGraph is not of type java.lang.Boolean", literal);
		return (java.lang.Boolean)obj;
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#uuid
	public org.openanzo.rdf.URI getUuid(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;
		if (!(statement.getObject() instanceof org.openanzo.rdf.URI))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": uuid getProperty() in org.openanzo.ontologies.openanzo.NamedGraph model not URI", statement.getObject());
		return (org.openanzo.rdf.URI)statement.getObject();
...
// generating for property: http://openanzo.org/ontologies/2008/07/Anzo#datasource
	...
	public org.openanzo.ontologies.system.Datasource getDatasource(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": datasource getProperty() in org.openanzo.ontologies.openanzo.NamedGraph model not Resource", statement.getObject());
...
/**
	...
	protected java.util.concurrent.CopyOnWriteArraySet<NamedGraphListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<NamedGraphListener>();
	
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
		if (!(listener instanceof NamedGraphListener)) {
			throw new org.openanzo.rdf.jastor.JastorException("Listener class not of proper type");
		}
		if(listeners.size()==0){
    		_dataset.registerListener(_listener);
    	}
    	NamedGraphListener list = (NamedGraphListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(createdProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(NamedGraphListener listener : listeners){
					listener.createdChanged(org.openanzo.ontologies.openanzo.NamedGraphImpl.this);
				}			
			}
			if (statement.getPredicate().equals(hasMetadataGraphProperty)) {
				for(NamedGraphListener listener : listeners){
					listener.hasMetadataGraphChanged(org.openanzo.ontologies.openanzo.NamedGraphImpl.this);
				}			
			}
			if (statement.getPredicate().equals(modifiedProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(NamedGraphListener listener : listeners){
					listener.modifiedChanged(org.openanzo.ontologies.openanzo.NamedGraphImpl.this);
				}			
			}
			if (statement.getPredicate().equals(persistedProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(NamedGraphListener listener : listeners){
					listener.persistedChanged(org.openanzo.ontologies.openanzo.NamedGraphImpl.this);
				}			
			}
			if (statement.getPredicate().equals(revisionProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(NamedGraphListener listener : listeners){
					listener.revisionChanged(org.openanzo.ontologies.openanzo.NamedGraphImpl.this);
				}			
			}
			if (statement.getPredicate().equals(revisionedProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(NamedGraphListener listener : listeners){
					listener.revisionedChanged(org.openanzo.ontologies.openanzo.NamedGraphImpl.this);
				}			
			}
			if (statement.getPredicate().equals(uuidProperty)) {
				for(NamedGraphListener listener : listeners){
					listener.uuidChanged(org.openanzo.ontologies.openanzo.NamedGraphImpl.this);
				}			
			}
			if (statement.getPredicate().equals(canBeAddedToByProperty)) {
				...
				if (_canBeAddedToBy != null) {
					for(NamedGraphListener listener : listeners){
						listener.canBeAddedToByAdded(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_canBeAddedToBy);
					}
				}			
			}
			if (statement.getPredicate().equals(canBeReadByProperty)) {
				...
				if (_canBeReadBy != null) {
					for(NamedGraphListener listener : listeners){
						listener.canBeReadByAdded(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_canBeReadBy);
					}
				}			
			}
			if (statement.getPredicate().equals(canBeRemovedFromByProperty)) {
				...
				if (_canBeRemovedFromBy != null) {
					for(NamedGraphListener listener : listeners){
						listener.canBeRemovedFromByAdded(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_canBeRemovedFromBy);
					}
				}			
			}
			if (statement.getPredicate().equals(createdByProperty)) {
				...
				if (_createdBy != null) {
					for(NamedGraphListener listener : listeners){
						listener.createdByAdded(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_createdBy);
					}
				}			
			}
			if (statement.getPredicate().equals(datasourceProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;				
				for(NamedGraphListener listener : listeners){
					listener.datasourceChanged(org.openanzo.ontologies.openanzo.NamedGraphImpl.this);
				}			
			}
			if (statement.getPredicate().equals(inheritsFromProperty)) {
				...
				if (_inheritsFrom != null) {
					for(NamedGraphListener listener : listeners){
						listener.inheritsFromAdded(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_inheritsFrom);
					}
				}			
			}
			if (statement.getPredicate().equals(lastModifiedByUserProperty)) {
				...
				if (_lastModifiedByUser != null) {
					for(NamedGraphListener listener : listeners){
						listener.lastModifiedByUserAdded(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_lastModifiedByUser);
					}
				}			
			}
		}}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(canBeAddedToByProperty)) {
				...
				if (_canBeAddedToBy != null) {
					for(NamedGraphListener listener : listeners){
						listener.canBeAddedToByRemoved(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_canBeAddedToBy);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(canBeReadByProperty)) {
				...
				if (_canBeReadBy != null) {
					for(NamedGraphListener listener : listeners){
						listener.canBeReadByRemoved(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_canBeReadBy);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(canBeRemovedFromByProperty)) {
				...
				if (_canBeRemovedFromBy != null) {
					for(NamedGraphListener listener : listeners){
						listener.canBeRemovedFromByRemoved(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_canBeRemovedFromBy);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(createdByProperty)) {
				...
				if (_createdBy != null) {
					for(NamedGraphListener listener : listeners){
						listener.createdByRemoved(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_createdBy);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(inheritsFromProperty)) {
				...
				if (_inheritsFrom != null) {
					for(NamedGraphListener listener : listeners){
						listener.inheritsFromRemoved(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_inheritsFrom);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(lastModifiedByUserProperty)) {
				...
				if (_lastModifiedByUser != null) {
					for(NamedGraphListener listener : listeners){
						listener.lastModifiedByUserRemoved(org.openanzo.ontologies.openanzo.NamedGraphImpl.this,_lastModifiedByUser);
					}
				}
				return;
			}

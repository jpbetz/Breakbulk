...
/**
 * Implementation of {@link org.openanzo.ontologies.system.HttpConfiguration}
 ...
 * <br>
 */
public class HttpConfigurationImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.system.HttpConfiguration {
	...
	HttpConfigurationImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static HttpConfigurationImpl getHttpConfiguration(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, HttpConfiguration.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new HttpConfigurationImpl(resource, namedGraphUri, dataset);
	}
	    
	static HttpConfigurationImpl createHttpConfiguration(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		HttpConfigurationImpl impl = new HttpConfigurationImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, HttpConfiguration.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, HttpConfiguration.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.ontologies.system.HttpConfiguration.TYPE, _graph.getNamedGraphUri()));
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#credentials
	...
	public org.openanzo.ontologies.system.Credentials getCredentials(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": credentials getProperty() in org.openanzo.ontologies.system.HttpConfiguration model not Resource", statement.getObject());
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#className
	public java.lang.String getClassName(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": className getProperty() in org.openanzo.ontologies.system.HttpConfiguration model not Literal", statement.getObject());
		...
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal className in HttpConfiguration is not of type java.lang.String", literal);
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#enabled
	public java.lang.Boolean getEnabled(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": enabled getProperty() in org.openanzo.ontologies.system.HttpConfiguration model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#boolean");
		if (!(obj instanceof java.lang.Boolean))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal enabled in HttpConfiguration is not of type java.lang.Boolean", literal);
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#initOrder
	public java.lang.Integer getInitOrder(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": initOrder getProperty() in org.openanzo.ontologies.system.HttpConfiguration model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#int");
		if (!(obj instanceof java.lang.Integer))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal initOrder in HttpConfiguration is not of type java.lang.Integer", literal);
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#networkTimeout
	public java.lang.Long getNetworkTimeout(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": networkTimeout getProperty() in org.openanzo.ontologies.system.HttpConfiguration model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#long");
		if (!(obj instanceof java.lang.Long))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal networkTimeout in HttpConfiguration is not of type java.lang.Long", literal);
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#connection
	...
	public org.openanzo.ontologies.system.NetworkConnection getConnection(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": connection getProperty() in org.openanzo.ontologies.system.HttpConfiguration model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
	...
	protected java.util.concurrent.CopyOnWriteArraySet<HttpConfigurationListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<HttpConfigurationListener>();
	
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
		if (!(listener instanceof HttpConfigurationListener)) {
			throw new org.openanzo.rdf.jastor.JastorException("Listener class not of proper type");
		}
		if(listeners.size()==0){
    		_dataset.registerListener(_listener);
    	}
    	HttpConfigurationListener list = (HttpConfigurationListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(credentialsProperty)) {
				...
				for(HttpConfigurationListener listener : listeners){
					listener.credentialsChanged(org.openanzo.ontologies.system.HttpConfigurationImpl.this);
				}			
			}
			if (statement.getPredicate().equals(classNameProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(HttpConfigurationListener listener : listeners){
					listener.classNameChanged(org.openanzo.ontologies.system.HttpConfigurationImpl.this);
				}			
			}
			if (statement.getPredicate().equals(enabledProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(HttpConfigurationListener listener : listeners){
					listener.enabledChanged(org.openanzo.ontologies.system.HttpConfigurationImpl.this);
				}			
			}
			if (statement.getPredicate().equals(initOrderProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(HttpConfigurationListener listener : listeners){
					listener.initOrderChanged(org.openanzo.ontologies.system.HttpConfigurationImpl.this);
				}			
			}
			if (statement.getPredicate().equals(dependencyProperty)) {
				...
				if (_dependency != null) {
					for(HttpConfigurationListener listener : listeners){
						listener.dependencyAdded(org.openanzo.ontologies.system.HttpConfigurationImpl.this,_dependency);
					}
				}			
			}
			if (statement.getPredicate().equals(networkTimeoutProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(HttpConfigurationListener listener : listeners){
					listener.networkTimeoutChanged(org.openanzo.ontologies.system.HttpConfigurationImpl.this);
				}			
			}
			if (statement.getPredicate().equals(connectionProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;				
				for(HttpConfigurationListener listener : listeners){
					listener.connectionChanged(org.openanzo.ontologies.system.HttpConfigurationImpl.this);
				}			
			}
		}}
		}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(dependencyProperty)) {
				...
				if (_dependency != null) {
					for(HttpConfigurationListener listener : listeners){
						listener.dependencyRemoved(org.openanzo.ontologies.system.HttpConfigurationImpl.this,_dependency);
					}
				}
				return;
			}

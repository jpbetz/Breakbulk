...
/**
 * Implementation of {@link org.openanzo.ontologies.system.Statistic}
 ...
 * <br>
 */
public class StatisticImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.system.Statistic {
	...
	StatisticImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static StatisticImpl getStatistic(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, Statistic.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new StatisticImpl(resource, namedGraphUri, dataset);
	}
	    
	static StatisticImpl createStatistic(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		StatisticImpl impl = new StatisticImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, Statistic.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, Statistic.TYPE, namedGraphUri);
		impl.addSuperTypes();
...
// generating for property: http://purl.org/dc/elements/1.1/title
	public java.lang.String getTitle(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": title getProperty() in org.openanzo.ontologies.system.Statistic model not Literal", statement.getObject());
		...
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal title in Statistic is not of type java.lang.String", literal);
...
// generating for property: http://purl.org/dc/elements/1.1/description
	public java.lang.String getDescription(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": description getProperty() in org.openanzo.ontologies.system.Statistic model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#string");
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal description in Statistic is not of type java.lang.String", literal);
		return (java.lang.String)obj;
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#statisticsEnabled
	public java.lang.Boolean getStatisticsEnabled(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": statisticsEnabled getProperty() in org.openanzo.ontologies.system.Statistic model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#boolean");
		if (!(obj instanceof java.lang.Boolean))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal statisticsEnabled in Statistic is not of type java.lang.Boolean", literal);
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.Long> propertyCollectionStatisticCount = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.Long>() {
		public java.lang.Long getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://openanzo.org/ontologies/2008/07/System#statisticCount properties in Statistic model not a Literal",value);
				}
			}
	};
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#statisticLastSampleTime
	public java.lang.Long getStatisticLastSampleTime(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": statisticLastSampleTime getProperty() in org.openanzo.ontologies.system.Statistic model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#long");
		if (!(obj instanceof java.lang.Long))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal statisticLastSampleTime in Statistic is not of type java.lang.Long", literal);
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#statisticStartTime
	public java.lang.Long getStatisticStartTime(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": statisticStartTime getProperty() in org.openanzo.ontologies.system.Statistic model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#long");
		if (!(obj instanceof java.lang.Long))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal statisticStartTime in Statistic is not of type java.lang.Long", literal);
		return (java.lang.Long)obj;
...
// generating for property: http://openanzo.org/ontologies/2008/07/System#statisticUnit
	public java.lang.String getStatisticUnit(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": statisticUnit getProperty() in org.openanzo.ontologies.system.Statistic model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#string");
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal statisticUnit in Statistic is not of type java.lang.String", literal);
		return (java.lang.String)obj;
	...
	protected java.util.concurrent.CopyOnWriteArraySet<StatisticListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<StatisticListener>();
	
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
		if (!(listener instanceof StatisticListener)) {
			throw new org.openanzo.rdf.jastor.JastorException("Listener class not of proper type");
		}
		if(listeners.size()==0){
    		_dataset.registerListener(_listener);
    	}
    	StatisticListener list = (StatisticListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(titleProperty)) {				
				...
				for(StatisticListener listener : listeners){
					listener.titleChanged(org.openanzo.ontologies.system.StatisticImpl.this);
				}			
			}
			if (statement.getPredicate().equals(descriptionProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(StatisticListener listener : listeners){
					listener.descriptionChanged(org.openanzo.ontologies.system.StatisticImpl.this);
				}			
			}
			if (statement.getPredicate().equals(statisticsEnabledProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(StatisticListener listener : listeners){
					listener.statisticsEnabledChanged(org.openanzo.ontologies.system.StatisticImpl.this);
				}			
			}
			if (statement.getPredicate().equals(statisticCountProperty)) {				
				...
				if (obj instanceof java.lang.Long) {
					for(StatisticListener listener : listeners){
						listener.statisticCountAdded(org.openanzo.ontologies.system.StatisticImpl.this,(java.lang.Long)obj);
					}
				}			
			}
			if (statement.getPredicate().equals(statisticLastSampleTimeProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(StatisticListener listener : listeners){
					listener.statisticLastSampleTimeChanged(org.openanzo.ontologies.system.StatisticImpl.this);
				}			
			}
			if (statement.getPredicate().equals(statisticStartTimeProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(StatisticListener listener : listeners){
					listener.statisticStartTimeChanged(org.openanzo.ontologies.system.StatisticImpl.this);
				}			
			}
			if (statement.getPredicate().equals(statisticUnitProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(StatisticListener listener : listeners){
					listener.statisticUnitChanged(org.openanzo.ontologies.system.StatisticImpl.this);
				}			
			}
		}}
		}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(statisticCountProperty)) {	
				...
				if (obj instanceof java.lang.Long) {
					for(StatisticListener listener : listeners){
						listener.statisticCountRemoved(org.openanzo.ontologies.system.StatisticImpl.this,(java.lang.Long)obj);
					}
				}
				return;
			}

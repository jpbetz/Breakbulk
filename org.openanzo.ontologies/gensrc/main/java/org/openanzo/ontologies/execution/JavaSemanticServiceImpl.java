...
/**
 * Implementation of {@link org.openanzo.ontologies.execution.JavaSemanticService}
 ...
 * <br>
 */
public class JavaSemanticServiceImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.ontologies.execution.JavaSemanticService {
	...
	protected static final org.openanzo.rdf.URI serviceFactoryPidProperty = org.openanzo.rdf.jastor.ThingFactory.valueFactory.createURI("http://openanzo.org/ontologies/2008/07/SemanticService#serviceFactoryPid");

	JavaSemanticServiceImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static JavaSemanticServiceImpl getJavaSemanticService(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, JavaSemanticService.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new JavaSemanticServiceImpl(resource, namedGraphUri, dataset);
	}
	    
	static JavaSemanticServiceImpl createJavaSemanticService(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		JavaSemanticServiceImpl impl = new JavaSemanticServiceImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, JavaSemanticService.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, JavaSemanticService.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource, serviceFactoryPidProperty, null, _graph.getNamedGraphUri()));
		
		
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.ontologies.execution.JavaSemanticService.TYPE, _graph.getNamedGraphUri()));
...
// generating for property: http://openanzo.org/ontologies/2008/07/SemanticService#serviceUser
	public java.lang.String getServiceUser(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": serviceUser getProperty() in org.openanzo.ontologies.execution.JavaSemanticService model not Literal", statement.getObject());
		...
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal serviceUser in JavaSemanticService is not of type java.lang.String", literal);
...
// generating for property: http://openanzo.org/ontologies/2008/07/SemanticService#stateStyle
	...
	public org.openanzo.ontologies.execution.StateStyleEnum getStateStyle(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": stateStyle getProperty() in org.openanzo.ontologies.execution.JavaSemanticService model not Resource", statement.getObject());
	...
	public void clearServiceFactoryPid(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException{
		_dataset.remove(_resource, serviceFactoryPidProperty, null,(includeEntireDataset)?null:_graph.getNamedGraphUri());
	}
// generating for property: http://openanzo.org/ontologies/2008/07/SemanticService#serviceFactoryPid
	public java.lang.String getServiceFactoryPid(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {

		java.util.Collection<org.openanzo.rdf.Statement> __valIter =null;
		__valIter =_dataset.find(includeEntireDataset, _resource, serviceFactoryPidProperty, null,_graph.getNamedGraphUri());
		if(__valIter.isEmpty()) return null;
		org.openanzo.rdf.Statement statement = __valIter.iterator().next();
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": serviceFactoryPid getProperty() in org.openanzo.ontologies.execution.JavaSemanticService model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#string");
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal serviceFactoryPid in JavaSemanticService is not of type java.lang.String", literal);
		return (java.lang.String)obj;
		
	}
	
	public java.lang.String getServiceFactoryPid() throws org.openanzo.rdf.jastor.JastorException {
		return getServiceFactoryPid(false);
	}
	
	public void setServiceFactoryPid(java.lang.String serviceFactoryPid) throws org.openanzo.rdf.jastor.JastorException {
		_dataset.remove(_resource, serviceFactoryPidProperty, null,_graph.getNamedGraphUri());                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
		if (serviceFactoryPid != null) {
	
			org.openanzo.rdf.Literal _literal = getLiteral(serviceFactoryPid,"http://www.w3.org/2001/XMLSchema#string");
			_dataset.add(_resource, serviceFactoryPidProperty, _literal,_graph.getNamedGraphUri());
	...
	protected java.util.concurrent.CopyOnWriteArraySet<JavaSemanticServiceListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<JavaSemanticServiceListener>();
	
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
		if (!(listener instanceof JavaSemanticServiceListener)) {
			throw new org.openanzo.rdf.jastor.JastorException("Listener class not of proper type");
		}
		if(listeners.size()==0){
    		_dataset.registerListener(_listener);
    	}
    	JavaSemanticServiceListener list = (JavaSemanticServiceListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(serviceUserProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(JavaSemanticServiceListener listener : listeners){
					listener.serviceUserChanged(org.openanzo.ontologies.execution.JavaSemanticServiceImpl.this);
				}			
			}
			if (statement.getPredicate().equals(operationProperty)) {
				...
				if (_operation != null) {
					for(JavaSemanticServiceListener listener : listeners){
						listener.operationAdded(org.openanzo.ontologies.execution.JavaSemanticServiceImpl.this,_operation);
					}
				}			
			}
			if (statement.getPredicate().equals(stateStyleProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;				
				for(JavaSemanticServiceListener listener : listeners){
					listener.stateStyleChanged(org.openanzo.ontologies.execution.JavaSemanticServiceImpl.this);
				}			
			}
			if (statement.getPredicate().equals(serviceFactoryPidProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(JavaSemanticServiceListener listener : listeners){
					listener.serviceFactoryPidChanged(org.openanzo.ontologies.execution.JavaSemanticServiceImpl.this);
				}			
			}
		}}
		}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(operationProperty)) {
				...
				if (_operation != null) {
					for(JavaSemanticServiceListener listener : listeners){
						listener.operationRemoved(org.openanzo.ontologies.execution.JavaSemanticServiceImpl.this,_operation);
					}
				}
				return;
			}

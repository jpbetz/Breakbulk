...
/**
 * Implementation of {@link org.openanzo.rdf.jastor.test.ski.TwinTip}
 * Use the org.openanzo.rdf.jastor.test.ski.SkiFactory to create instances of this class.
 * <p>(URI: http://jastor.openanzo.org/testonts/classes#TwinTip)</p>
 * <br>
 */
public class TwinTipImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.rdf.jastor.test.ski.TwinTip {
	...
	TwinTipImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
		_listener = new ThingStatementListener();
	}   
	   
    	
	static TwinTipImpl getTwinTip(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, TwinTip.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		if (!dataset.contains(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, TwinTip.TYPE, namedGraphUri))
			return null;
		return new TwinTipImpl(resource, namedGraphUri, dataset);
	}
	    
	static TwinTipImpl createTwinTip(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		TwinTipImpl impl = new TwinTipImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, TwinTip.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, TwinTip.TYPE, namedGraphUri);
		impl.addSuperTypes();
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#designer
	...
	public org.openanzo.rdf.jastor.test.ski.Ski getDesigner(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": designer getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Resource", statement.getObject());
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#attribute
	public org.openanzo.rdf.Literal getAttribute(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": attribute getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Literal", statement.getObject());
	...
	public java.lang.String getAttribute_asString(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": attribute_asString getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#string");
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal attribute_asString in TwinTip is not of type java.lang.String", literal);
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.Integer> propertyCollectionAvailableLength = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.Integer>() {
		public java.lang.Integer getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://jastor.openanzo.org/testonts/predicates#availableLength properties in TwinTip model not a Literal",value);
				}
			}
	};
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#coreConstruction
	public java.lang.String getCoreConstruction(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": coreConstruction getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#string");
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal coreConstruction in TwinTip is not of type java.lang.String", literal);
		return (java.lang.String)obj;
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionCoreMaterial = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://jastor.openanzo.org/testonts/predicates#coreMaterial properties in TwinTip model not a Literal",value);
				}
			}
	};
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#manufacturer
	public java.lang.String getManufacturer(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": manufacturer getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#string");
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal manufacturer in TwinTip is not of type java.lang.String", literal);
		return (java.lang.String)obj;
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#model
	public java.lang.String getModel(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": model getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#string");
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal model in TwinTip is not of type java.lang.String", literal);
		return (java.lang.String)obj;
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#partnum
	public java.lang.Long getPartnum(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": partnum getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#long");
		if (!(obj instanceof java.lang.Long))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal partnum in TwinTip is not of type java.lang.Long", literal);
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.Long> propertyCollectionRelatedPartnum = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.Long>() {
		public java.lang.Long getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://jastor.openanzo.org/testonts/predicates#relatedPartnum properties in TwinTip model not a Literal",value);
				}
			}
	};
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#website
	public org.openanzo.rdf.URI getWebsite(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!(statement.getObject() instanceof org.openanzo.rdf.URI))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": website getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not URI", statement.getObject());
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#identifier
	...
	public org.openanzo.rdf.jastor.Thing getIdentifier(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": identifier getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#mostSimilarTo
	...
	public org.openanzo.rdf.jastor.test.ski.Ski getMostSimilarTo(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": mostSimilarTo getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
		return org.openanzo.rdf.jastor.test.ski.SkiFactory.getSki(resource,(includeEntireDataset)?null:_graph.getNamedGraphUri(),_dataset);
	...
	public org.openanzo.rdf.jastor.test.ski.TwinTip getMostSimilarTo_asTwinTip(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": mostSimilarTo_asTwinTip getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#sidewall
	...
	public org.openanzo.rdf.jastor.test.ski.SidewallEnum getSidewall(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": sidewall getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.Boolean> propertyCollectionIsAlpine = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.Boolean>() {
		public java.lang.Boolean getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://jastor.openanzo.org/testonts/predicates#isAlpine properties in TwinTip model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionPreferredStance = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://jastor.openanzo.org/testonts/predicates#preferredStance properties in TwinTip model not a Literal",value);
				}
			}
	};
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#specialty
	public java.lang.Integer getSpecialty(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": specialty getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#int");
		if (!(obj instanceof java.lang.Integer))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal specialty in TwinTip is not of type java.lang.Integer", literal);
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionProRider = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://jastor.openanzo.org/testonts/predicates#proRider properties in TwinTip model not a Literal",value);
				}
			}
	};
...
// generating for property: http://jastor.openanzo.org/altnamespace/predicates#model
	public java.lang.String getNs1_Model(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": ns1_model getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#string");
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal ns1_model in TwinTip is not of type java.lang.String", literal);
		return (java.lang.String)obj;
...
// generating for property: http://jastor.openanzo.org/testonts/predicates#pipeOrPark
	public java.lang.String getPipeOrPark(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null) return null;		
		if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": pipeOrPark getProperty() in org.openanzo.rdf.jastor.test.ski.TwinTip model not Literal", statement.getObject());
		org.openanzo.rdf.Literal literal=(org.openanzo.rdf.Literal)statement.getObject();
		Object obj = getLiteralValue(literal, "http://www.w3.org/2001/XMLSchema#string");
		if (!(obj instanceof java.lang.String))
			throw new org.openanzo.rdf.jastor.InvalidLiteralException (this.uri() + ": Literal pipeOrPark in TwinTip is not of type java.lang.String", literal);
		return (java.lang.String)obj;
	...
	protected java.util.concurrent.CopyOnWriteArraySet<TwinTipListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<TwinTipListener>();
	
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
		if (!(listener instanceof TwinTipListener)) {
			throw new org.openanzo.rdf.jastor.JastorException("Listener class not of proper type");
		}
		if(listeners.size()==0){
    		_dataset.registerListener(_listener);
    	}
    	TwinTipListener list = (TwinTipListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(designerProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;				
				for(TwinTipListener listener : listeners){
					listener.designerChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(attributeProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(TwinTipListener listener : listeners){
					listener.attributeChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(availableLengthProperty)) {				
				...
				if (obj instanceof java.lang.Integer) {
					for(TwinTipListener listener : listeners){
						listener.availableLengthAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.Integer)obj);
					}
				}			
			}
			if (statement.getPredicate().equals(coreConstructionProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(TwinTipListener listener : listeners){
					listener.coreConstructionChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(coreMaterialProperty)) {				
				...
				if (obj instanceof java.lang.String) {
					for(TwinTipListener listener : listeners){
						listener.coreMaterialAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.String)obj);
					}
				}			
			}
			if (statement.getPredicate().equals(manufacturerProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(TwinTipListener listener : listeners){
					listener.manufacturerChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(modelProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(TwinTipListener listener : listeners){
					listener.modelChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(partnumProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(TwinTipListener listener : listeners){
					listener.partnumChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(relatedPartnumProperty)) {				
				...
				if (obj instanceof java.lang.Long) {
					for(TwinTipListener listener : listeners){
						listener.relatedPartnumAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.Long)obj);
					}
				}			
			}
			if (statement.getPredicate().equals(websiteProperty)) {
				for(TwinTipListener listener : listeners){
					listener.websiteChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(competesWithProperty)) {
				...
				if (_competesWith != null) {
					for(TwinTipListener listener : listeners){
						listener.competesWithAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_competesWith);
					}
				}
				...
				if (_competesWith_asTwinTip != null) {
					for(TwinTipListener listener : listeners){
						listener.competesWithAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_competesWith_asTwinTip);
					}
				}			
			}
			if (statement.getPredicate().equals(identifierProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;				
				for(TwinTipListener listener : listeners){
					listener.identifierChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(mostSimilarToProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;				
				for(TwinTipListener listener : listeners){
					listener.mostSimilarToChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(multiIdentifierProperty)) {
				...
				if (_multiIdentifier != null) {
					for(TwinTipListener listener : listeners){
						listener.multiIdentifierAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_multiIdentifier);
					}
				}			
			}
			if (statement.getPredicate().equals(previousModelProperty)) {
				...
				if (_previousModel != null) {
					for(TwinTipListener listener : listeners){
						listener.previousModelAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_previousModel);
					}
				}			
			}
			if (statement.getPredicate().equals(sidewallProperty)) {
				if (!(statement.getObject() instanceof org.openanzo.rdf.Resource))
					return;				
				for(TwinTipListener listener : listeners){
					listener.sidewallChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(isAlpineProperty)) {				
				...
				if (obj instanceof java.lang.Boolean) {
					for(TwinTipListener listener : listeners){
						listener.isAlpineAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.Boolean)obj);
					}
				}			
			}
			if (statement.getPredicate().equals(isFreestyleProperty)) {
				...
				if (_isFreestyle != null) {
					for(TwinTipListener listener : listeners){
						listener.isFreestyleAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_isFreestyle);
					}
				}			
			}
			if (statement.getPredicate().equals(preferredStanceProperty)) {				
				...
				if (obj instanceof java.lang.String) {
					for(TwinTipListener listener : listeners){
						listener.preferredStanceAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.String)obj);
					}
				}			
			}
			if (statement.getPredicate().equals(complimentBoardProperty)) {
				...
				if (_complimentBoard != null) {
					for(TwinTipListener listener : listeners){
						listener.complimentBoardAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_complimentBoard);
					}
				}			
			}
			if (statement.getPredicate().equals(specialtyProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(TwinTipListener listener : listeners){
					listener.specialtyChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(proRiderProperty)) {				
				...
				if (obj instanceof java.lang.String) {
					for(TwinTipListener listener : listeners){
						listener.proRiderAdded(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.String)obj);
					}
				}			
			}
			if (statement.getPredicate().equals(ns1_modelProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(TwinTipListener listener : listeners){
					listener.ns1_modelChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
			if (statement.getPredicate().equals(pipeOrParkProperty)) {				
				if (!(statement.getObject() instanceof org.openanzo.rdf.Literal))
					return;		
				for(TwinTipListener listener : listeners){
					listener.pipeOrParkChanged(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this);
				}			
			}
		}}
		}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(availableLengthProperty)) {	
				...
				if (obj instanceof java.lang.Integer) {
					for(TwinTipListener listener : listeners){
						listener.availableLengthRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.Integer)obj);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(coreMaterialProperty)) {	
				...
				if (obj instanceof java.lang.String) {
					for(TwinTipListener listener : listeners){
						listener.coreMaterialRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(relatedPartnumProperty)) {	
				...
				if (obj instanceof java.lang.Long) {
					for(TwinTipListener listener : listeners){
						listener.relatedPartnumRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.Long)obj);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(competesWithProperty)) {
				...
				if (_competesWith != null) {
					for(TwinTipListener listener : listeners){
						listener.competesWithRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_competesWith);
					}
				}
				org.openanzo.rdf.jastor.test.ski.TwinTip _competesWith_asTwinTip = org.openanzo.rdf.jastor.test.ski.SkiFactory.getTwinTip(resource,_graph.getNamedGraphUri(),dataset());
				if (_competesWith_asTwinTip != null) {
					for(TwinTipListener listener : listeners){
						listener.competesWithRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_competesWith_asTwinTip);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(multiIdentifierProperty)) {
				...
				if (_multiIdentifier != null) {
					for(TwinTipListener listener : listeners){
						listener.multiIdentifierRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_multiIdentifier);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(previousModelProperty)) {
				...
				if (_previousModel != null) {
					for(TwinTipListener listener : listeners){
						listener.previousModelRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_previousModel);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(isAlpineProperty)) {	
				...
				if (obj instanceof java.lang.Boolean) {
					for(TwinTipListener listener : listeners){
						listener.isAlpineRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.Boolean)obj);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(isFreestyleProperty)) {
				...
				if (_isFreestyle != null) {
					for(TwinTipListener listener : listeners){
						listener.isFreestyleRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_isFreestyle);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(preferredStanceProperty)) {	
				...
				if (obj instanceof java.lang.String) {
					for(TwinTipListener listener : listeners){
						listener.preferredStanceRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(complimentBoardProperty)) {
				...
				if (_complimentBoard != null) {
					for(TwinTipListener listener : listeners){
						listener.complimentBoardRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,_complimentBoard);
					}
				}
				return;
			}
			...
			if (statement.getPredicate().equals(proRiderProperty)) {	
				...
				if (obj instanceof java.lang.String) {
					for(TwinTipListener listener : listeners){
						listener.proRiderRemoved(org.openanzo.rdf.jastor.test.ski.TwinTipImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}

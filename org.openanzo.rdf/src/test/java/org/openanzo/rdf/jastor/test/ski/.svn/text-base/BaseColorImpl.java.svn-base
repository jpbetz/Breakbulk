...
/**
 * Implementation of {@link org.openanzo.rdf.jastor.test.ski.BaseColor}
 * Use the org.openanzo.rdf.jastor.test.ski.SkiFactory to create instances of this class.
 * <p>(URI: http://jastor.openanzo.org/testonts/classes#BaseColor)</p>
 * <br>
 */
public class BaseColorImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.rdf.jastor.test.ski.BaseColor {
	...
	BaseColorImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
	...
	static {
		oneOfClasses.add(Black);
		oneOfClasses.add(White);
		oneOfClasses.add(Grey);
	}   
    	
	static BaseColorImpl getBaseColor(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, BaseColor.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		if (!dataset.contains(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, BaseColor.TYPE, namedGraphUri))
			return null;
		return new BaseColorImpl(resource, namedGraphUri, dataset);
	}
	    
	static BaseColorImpl createBaseColor(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if (!oneOfClasses.contains(resource)) {
			throw new org.openanzo.rdf.jastor.JastorException("Resource " + resource + " not a member of enumeration class http://jastor.openanzo.org/testonts/classes#BaseColor"); 
		} 
		
		BaseColorImpl impl = new BaseColorImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, BaseColor.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, BaseColor.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.rdf.jastor.test.ski.BaseColor.TYPE, _graph.getNamedGraphUri()));
		return list;
	}
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.Boolean> propertyCollectionIsAlpine = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.Boolean>() {
		public java.lang.Boolean getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://jastor.openanzo.org/testonts/predicates#isAlpine properties in BaseColor model not a Literal",value);
				}
			}
	};
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionPreferredStance = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://jastor.openanzo.org/testonts/predicates#preferredStance properties in BaseColor model not a Literal",value);
				}
			}
	};
...
/**
	...
	protected java.util.concurrent.CopyOnWriteArraySet<BaseColorListener> listeners = new  java.util.concurrent.CopyOnWriteArraySet<BaseColorListener>();
	
	public void registerListener(org.openanzo.rdf.jastor.ThingListener listener) {
		if (!(listener instanceof BaseColorListener)) {
			throw new org.openanzo.rdf.jastor.JastorException("Listener class not of proper type");
		}
		if(listeners.size()==0){
    		_dataset.registerListener(_listener);
    	}
    	BaseColorListener list = (BaseColorListener)listener;
	...
	protected class ThingStatementListener implements org.openanzo.rdf.IStatementListener<org.openanzo.rdf.IDataset> {
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(isAlpineProperty)) {				
				...
				if (obj instanceof java.lang.Boolean) {
					for(BaseColorListener listener : listeners){
						listener.isAlpineAdded(org.openanzo.rdf.jastor.test.ski.BaseColorImpl.this,(java.lang.Boolean)obj);
					}
				}			
			}
			if (statement.getPredicate().equals(isFreestyleProperty)) {
				...
				if (_isFreestyle != null) {
					for(BaseColorListener listener : listeners){
						listener.isFreestyleAdded(org.openanzo.rdf.jastor.test.ski.BaseColorImpl.this,_isFreestyle);
					}
				}			
			}
			if (statement.getPredicate().equals(preferredStanceProperty)) {				
				...
				if (obj instanceof java.lang.String) {
					for(BaseColorListener listener : listeners){
						listener.preferredStanceAdded(org.openanzo.rdf.jastor.test.ski.BaseColorImpl.this,(java.lang.String)obj);
					}
				}			
			}
			if (statement.getPredicate().equals(complimentBoardProperty)) {
				...
				if (_complimentBoard != null) {
					for(BaseColorListener listener : listeners){
						listener.complimentBoardAdded(org.openanzo.rdf.jastor.test.ski.BaseColorImpl.this,_complimentBoard);
					}
				}			
			}
		}}
		...
		for(org.openanzo.rdf.Statement statement:statements){
			...
			if (statement.getPredicate().equals(isAlpineProperty)) {	
				...
				if (obj instanceof java.lang.Boolean) {
					for(BaseColorListener listener : listeners){
						listener.isAlpineRemoved(org.openanzo.rdf.jastor.test.ski.BaseColorImpl.this,(java.lang.Boolean)obj);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(isFreestyleProperty)) {
				...
				if (_isFreestyle != null) {
					for(BaseColorListener listener : listeners){
						listener.isFreestyleRemoved(org.openanzo.rdf.jastor.test.ski.BaseColorImpl.this,_isFreestyle);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(preferredStanceProperty)) {	
				...
				if (obj instanceof java.lang.String) {
					for(BaseColorListener listener : listeners){
						listener.preferredStanceRemoved(org.openanzo.rdf.jastor.test.ski.BaseColorImpl.this,(java.lang.String)obj);
					}
				}
				return;
			}
			if (statement.getPredicate().equals(complimentBoardProperty)) {
				...
				if (_complimentBoard != null) {
					for(BaseColorListener listener : listeners){
						listener.complimentBoardRemoved(org.openanzo.rdf.jastor.test.ski.BaseColorImpl.this,_complimentBoard);
					}
				}
				return;
			}

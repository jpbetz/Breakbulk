 ...
 *
 */
public class NumericAdd extends BinaryFunction implements InfixOperator {
	@Override
	public Value call(Value arg1, Value arg2)
		...
		return new PolymorphicNumber(arg1).add(new PolymorphicNumber(arg2)).asTypedLiteral();
	}
	
	public URI getIdentifier() {
		return Glitter.createURI(NAMESPACES.OP_NAMESPACE + "numeric-add");
	}

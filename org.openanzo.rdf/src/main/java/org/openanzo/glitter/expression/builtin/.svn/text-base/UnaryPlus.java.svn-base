 ...
 * 
  * File: $Source: /cvsroot/slrp/glitter/com.ibm.adtech.glitter/src/com/ibm/adtech/glitter/expression/builtin/UnaryPlus.java,v $
 * Created by:  Lee Feigenbaum (<a href="mailto:feigenbl@us.ibm.com">feigenbl@us.ibm.com</a>) 
 * Created on: 10/23/06
 * Revision: $Id: UnaryPlus.java 164 2007-07-31 14:11:09Z mroy $
 * 
...
public class UnaryPlus extends UnaryFunction implements PrefixOperator{
	...
	public URI getIdentifier() {
		return Glitter.createURI(NAMESPACES.OP_NAMESPACE + "numeric-unary-plus");
	}

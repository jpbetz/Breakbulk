...
/**
 * Implements <a href="http://www.w3.org/TR/rdf-sparql-query/#func-RDFterm-equal">the SPARQL RDFterm-equal function</a>.
 * 
...
public class RDFTermEq extends BinaryFunction implements InfixOperator {
    ...
    public URI getIdentifier() {
        return Glitter.createURI(NAMESPACES.BUILTIN_NAMESPACE + "RDFterm-equal");
    }

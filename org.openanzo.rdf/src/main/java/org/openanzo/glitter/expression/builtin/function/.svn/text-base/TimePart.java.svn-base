...
/**
 * Given an xsd:time or an xsd:dateTime, returns the appropriate xsd:time
 * 
 * @author lee <lee@cambridgesemantics.com>
 * 
 */
public class TimePart extends UnaryFunction {
        ...
        if (arg1 instanceof TypedLiteral) {
            ...
            if (dt.equals(XMLSchema.TIME))
                ...
                try {
                    ...
                    throw new MalformedLiteralException(arg1, "xsd:dateTime or xsd:time");
                }
                XMLGregorianCalendar time = TypeMaps.datatypeFactory.newXMLGregorianCalendarTime(dateTime.getHour(), dateTime.getMinute(), dateTime.getSecond(), dateTime.getMillisecond(), dateTime.getTimezone());
                return MemTypedLiteral.create(time);
            }
        }
        throw new IncompatibleTypeException(arg1, "typed literal of xsd:time or xsd:dateTime");
    }

    public URI getIdentifier() {
        return Glitter.createURI(NAMESPACES.GLITTER_FUNCTION_NAMESPACE + "timePart");
    }

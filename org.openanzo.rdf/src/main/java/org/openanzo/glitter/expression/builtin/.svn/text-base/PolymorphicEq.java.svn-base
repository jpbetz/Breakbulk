 ...
 *
 * File: $Source: /cvsroot/slrp/glitter/com.ibm.adtech.glitter/src/com/ibm/adtech/glitter/expression/builtin/PolymorphicEq.java,v $
 * Created by:  Lee Feigenbaum (<a href="mailto:feigenbl@us.ibm.com">feigenbl@us.ibm.com</a>)
 * Created on: 10/23/06
 * Revision: $Id: PolymorphicEq.java 164 2007-07-31 14:11:09Z mroy $
 *
...
public class PolymorphicEq extends BinaryFunction implements InfixOperator {
    ...
    public Value call(Value arg1, Value arg2) throws ExpressionEvaluationException {
        if (arg1 instanceof Literal && arg2 instanceof Literal) {
            ComparisonResult result = compareLiteralValues(arg1, arg2);
            if (result == ComparisonResult.INDETERMINATE) {
                return new RDFTermEq().call(arg1, arg2);
            } else {
                return result == ComparisonResult.EQUAL ? Constants.TRUE : Constants.FALSE;
            }
        } else {
            return new RDFTermEq().call(arg1, arg2);
        }

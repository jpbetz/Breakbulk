 ...
 *
  * File: $Source: /cvsroot/slrp/glitter/com.ibm.adtech.glitter/src/com/ibm/adtech/glitter/expression/builtin/PolymorphicLe.java,v $
 * Created by:  Lee Feigenbaum (<a href="mailto:feigenbl@us.ibm.com">feigenbl@us.ibm.com</a>)
 * Created on: 10/23/06
 * Revision: $Id: PolymorphicLe.java 164 2007-07-31 14:11:09Z mroy $
 *
 ...
 *
 */
public class PolymorphicLe extends BinaryFunction implements InfixOperator {
    ...
    public Value call(Value arg1, Value arg2) throws ExpressionEvaluationException {
        ...
        return (cr == ComparisonResult.EQUAL || cr == ComparisonResult.LESSER) ? Constants.TRUE : Constants.FALSE;
    }

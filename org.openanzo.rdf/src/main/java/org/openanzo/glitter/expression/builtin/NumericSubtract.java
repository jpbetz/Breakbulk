 ...
 * 
  * File: $Source: /cvsroot/slrp/glitter/com.ibm.adtech.glitter/src/com/ibm/adtech/glitter/expression/builtin/NumericSubtract.java,v $
 * Created by:  Lee Feigenbaum (<a href="mailto:feigenbl@us.ibm.com">feigenbl@us.ibm.com</a>) 
 * Created on: 10/23/06
 * Revision: $Id: NumericSubtract.java 164 2007-07-31 14:11:09Z mroy $
 * 
 ...
 *
 */public class NumericSubtract extends BinaryFunction implements InfixOperator {
	@Override
	public Value call(Value arg1, Value arg2)
		...
		return new PolymorphicNumber(arg1).subtract(new PolymorphicNumber(arg2)).asTypedLiteral();
	}
	
	public URI getIdentifier() {
		return Glitter.createURI(NAMESPACES.OP_NAMESPACE + "numeric-subtract");
	}

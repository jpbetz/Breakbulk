...
public class PolymorphicAdd extends BinaryFunction implements InfixOperator {
    ...
    public Value call(Value arg1, Value arg2) throws ExpressionEvaluationException {
        ...
        try {
            return new NumericAdd().call(arg1, arg2);
        } catch (ExpressionEvaluationException e) {
            // no-op
        }
        try {
            return new DateTimeAdd().call(arg1, arg2);
        } catch (ExpressionEvaluationException e) {
            // no-op
        }
        try {
            return new DateTimeAdd().call(arg2, arg1);
        } catch (ExpressionEvaluationException e) {
            // no-op
        }
        throw new IncompatibleTypeException(arg1, "Can only add numerics or dates/datetimes/times and durations.");
    }

    public URI getIdentifier() {
        return Glitter.createURI(NAMESPACES.OP_NAMESPACE + "add");
    }

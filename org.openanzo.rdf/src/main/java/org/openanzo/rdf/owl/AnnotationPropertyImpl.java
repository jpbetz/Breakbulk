...
/**
 * Implementation of {@link org.openanzo.rdf.owl.AnnotationProperty}
 * Use the org.openanzo.rdf.owl.OWL11Factory to create instances of this class.
 * <p>(URI: http://www.w3.org/2002/07/owl#AnnotationProperty)</p>
 * <br>
 */
public class AnnotationPropertyImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.rdf.owl.AnnotationProperty {
	...
	AnnotationPropertyImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
	}   
	   
    	
	static AnnotationPropertyImpl getAnnotationProperty(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, AnnotationProperty.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new AnnotationPropertyImpl(resource, namedGraphUri, dataset);
	}
	    
	static AnnotationPropertyImpl createAnnotationProperty(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		AnnotationPropertyImpl impl = new AnnotationPropertyImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, AnnotationProperty.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, AnnotationProperty.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.rdf.owl.AnnotationProperty.TYPE, _graph.getNamedGraphUri()));
	 ...
	 * @see			org.openanzo.rdf.owl.AnnotationProperty#commentProperty
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#comment
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionComment = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#comment properties in AnnotationProperty model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.AnnotationProperty#labelProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#label
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionLabel = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#label properties in AnnotationProperty model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.AnnotationProperty#typeProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.AnnotationProperty#valueProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.AnnotationProperty#isDefinedByProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.AnnotationProperty#memberProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.AnnotationProperty#seeAlsoProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.AnnotationProperty#differentFromProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.AnnotationProperty#sameAsProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */

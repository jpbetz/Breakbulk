...
/**
 * Implementation of {@link org.openanzo.rdf.owl._Thing}
 * Use the org.openanzo.rdf.owl.OWL11Factory to create instances of this class.
 * <p>(URI: http://www.w3.org/2002/07/owl#Thing)</p>
 * <br>
 */
public class _ThingImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.rdf.owl._Thing {
	...
	_ThingImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
	}   
	   
    	
	static _ThingImpl get_Thing(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, _Thing.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new _ThingImpl(resource, namedGraphUri, dataset);
	}
	    
	static _ThingImpl create_Thing(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		_ThingImpl impl = new _ThingImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, _Thing.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, _Thing.TYPE, namedGraphUri);
		impl.addSuperTypes();
	 ...
	 * @see			org.openanzo.rdf.owl._Thing#commentProperty
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#comment
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionComment = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#comment properties in _Thing model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#labelProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#label
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionLabel = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#label properties in _Thing model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#typeProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#valueProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#isDefinedByProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#memberProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#seeAlsoProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#subClassOfProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#oneOfProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2002/07/owl#oneOf
	...
	public org.openanzo.rdf.jastor.Thing getOneOf(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": oneOf getProperty() in org.openanzo.rdf.owl._Thing model not Resource", statement.getObject());
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#disjointWithProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#equivalentClassProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#intersectionOfProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2002/07/owl#intersectionOf
	...
	public org.openanzo.rdf.jastor.Thing getIntersectionOf(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": intersectionOf getProperty() in org.openanzo.rdf.owl._Thing model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
		return org.openanzo.rdf.jastor.ThingFactory.getThing(resource,(includeEntireDataset)?null:_graph.getNamedGraphUri(),_dataset);
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#unionOfProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2002/07/owl#unionOf
	...
	public org.openanzo.rdf.jastor.Thing getUnionOf(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": unionOf getProperty() in org.openanzo.rdf.owl._Thing model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
		return org.openanzo.rdf.jastor.ThingFactory.getThing(resource,(includeEntireDataset)?null:_graph.getNamedGraphUri(),_dataset);
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl._Thing#disjointUnionOfProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */

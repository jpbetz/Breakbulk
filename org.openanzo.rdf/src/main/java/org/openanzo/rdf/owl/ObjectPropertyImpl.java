...
/**
 * Implementation of {@link org.openanzo.rdf.owl.ObjectProperty}
 ...
 * <br>
 */
public class ObjectPropertyImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.rdf.owl.ObjectProperty {
	...
	ObjectPropertyImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
	}   
	   
    	
	static ObjectPropertyImpl getObjectProperty(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, ObjectProperty.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new ObjectPropertyImpl(resource, namedGraphUri, dataset);
	}
	    
	static ObjectPropertyImpl createObjectProperty(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		ObjectPropertyImpl impl = new ObjectPropertyImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, ObjectProperty.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, ObjectProperty.TYPE, namedGraphUri);
		impl.addSuperTypes();
	 ...
	 * @see			org.openanzo.rdf.owl.ObjectProperty#commentProperty
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#comment
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionComment = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#comment properties in ObjectProperty model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#labelProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#label
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionLabel = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#label properties in ObjectProperty model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#typeProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#valueProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#isDefinedByProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#memberProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#seeAlsoProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#domainProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#domain
	...
	public org.openanzo.rdf.rdfs.Class getDomain(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": domain getProperty() in org.openanzo.rdf.owl.ObjectProperty model not Resource", statement.getObject());
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#rangeProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#range
	...
	public org.openanzo.rdf.rdfs.Class getRange(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": range getProperty() in org.openanzo.rdf.owl.ObjectProperty model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
		return org.openanzo.rdf.rdfs.RDFSFactory.getClass(resource,(includeEntireDataset)?null:_graph.getNamedGraphUri(),_dataset);
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#subPropertyOfProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#inverseOfProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#disjointObjectPropertiesProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#equivalentObjectPropertyProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#objectPropertyDomainProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2006/12/owl11#objectPropertyDomain
	...
	public org.openanzo.rdf.owl.Class getObjectPropertyDomain(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": objectPropertyDomain getProperty() in org.openanzo.rdf.owl.ObjectProperty model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#objectPropertyRangeProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2006/12/owl11#objectPropertyRange
	...
	public org.openanzo.rdf.owl.Class getObjectPropertyRange(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": objectPropertyRange getProperty() in org.openanzo.rdf.owl.ObjectProperty model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
		return org.openanzo.rdf.owl.OWL11Factory.getClass(resource,(includeEntireDataset)?null:_graph.getNamedGraphUri(),_dataset);
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.owl.ObjectProperty#subObjectPropertyOfProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */

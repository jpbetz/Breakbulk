...
public class ListenerAdapterTemplate implements OntologyClassTemplate {
	
  protected static String nl;
  public static synchronized ListenerAdapterTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    ListenerAdapterTemplate result = new ListenerAdapterTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_8 = " to " + NL + " * receive notification when properties changed, added or removed." + NL + " * <br>" + NL + " */" + NL + "public class  ";
  protected final String TEXT_9 = "Adapter implements ";
  protected final String TEXT_10 = " {" + NL;
  protected final String TEXT_11 = NL;
  protected final String TEXT_12 = NL + "\t/**" + NL + "\t * Called when ";
  protected final String TEXT_13 = " has changed" + NL + "\t * @param source the affected instance of ";
  protected final String TEXT_14 = NL + "\t */" + NL + "\tpublic void ";
  protected final String TEXT_15 = "Changed(";
  protected final String TEXT_16 = " source){}" + NL;
  protected final String TEXT_17 = NL + "\t/**" + NL + "\t * Called when a value of ";
  protected final String TEXT_18 = " has been added" + NL + "\t * @param source the affected instance of ";
  protected final String TEXT_19 = NL + "\t * @param newValue the object representing the new value" + NL + "\t */\t" + NL + "\tpublic void ";
  protected final String TEXT_20 = "Added(";
  protected final String TEXT_21 = " source, ";
  protected final String TEXT_22 = " newValue){}" + NL + "" + NL + "\t/**" + NL + "\t * Called when a value of ";
  protected final String TEXT_23 = " has been removed" + NL + "\t * @param source the affected instance of ";
  protected final String TEXT_24 = NL + "\t * @param oldValue the object representing the removed value" + NL + "\t */\t" + NL + "\tpublic void ";
  protected final String TEXT_25 = "Removed(";
  protected final String TEXT_26 = " source, ";
  protected final String TEXT_27 = " oldValue){}" + NL;
  protected final String TEXT_28 = NL + "\t/**" + NL + "\t * Called when ";
  protected final String TEXT_29 = " has changed" + NL + "\t * @param source the affected instance of ";
  protected final String TEXT_30 = NL + "\t */" + NL + "\tpublic void ";
  protected final String TEXT_31 = "Changed(";
  protected final String TEXT_32 = " source){}" + NL;
  protected final String TEXT_33 = NL + "\t/**" + NL + "\t * Called when a value of ";
  protected final String TEXT_34 = " has been added" + NL + "\t * @param source the affected instance of ";
  protected final String TEXT_35 = NL + "\t * @param newValue the object representing the new value" + NL + "\t */\t" + NL + "\tpublic void ";
  protected final String TEXT_36 = "Added(";
  protected final String TEXT_37 = " source, ";
  protected final String TEXT_38 = " newValue){}" + NL + "" + NL + "\t/**" + NL + "\t * Called when a value of ";
  protected final String TEXT_39 = " has been removed" + NL + "\t * @param source the affected instance of ";
  protected final String TEXT_40 = NL + "\t * @param oldValue the object representing the removed value" + NL + "\t */" + NL + "\tpublic void ";
  protected final String TEXT_41 = "Removed(";
  protected final String TEXT_42 = " source, ";
  protected final String TEXT_43 = " oldValue){}" + NL + "\t\t";
  protected final String TEXT_44 = NL + "}";

	OntologyClassFileProvider fileProvider;

	public ListenerAdapterTemplate(OntologyClassFileProvider fileProvider) {
		this.fileProvider = fileProvider;
	}
	
	public ListenerAdapterTemplate() {
	}

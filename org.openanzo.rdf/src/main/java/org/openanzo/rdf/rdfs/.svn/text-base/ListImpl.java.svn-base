...
/**
 * Implementation of {@link org.openanzo.rdf.rdfs.List}
 * Use the org.openanzo.rdf.rdfs.RDFSFactory to create instances of this class.
 * <p>(URI: http://www.w3.org/1999/02/22-rdf-syntax-ns#List)</p>
 * <br>
 */
public class ListImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.rdf.rdfs.List {
	...
	protected static final org.openanzo.rdf.URI firstProperty = org.openanzo.rdf.jastor.ThingFactory.valueFactory.createURI("http://www.w3.org/1999/02/22-rdf-syntax-ns#first");
	protected static final org.openanzo.rdf.URI restProperty = org.openanzo.rdf.jastor.ThingFactory.valueFactory.createURI("http://www.w3.org/1999/02/22-rdf-syntax-ns#rest");

	ListImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
	}   
	   
    	
	static ListImpl getList(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, List.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new ListImpl(resource, namedGraphUri, dataset);
	}
	    
	static ListImpl createList(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		ListImpl impl = new ListImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, List.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, List.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource, firstProperty, null, _graph.getNamedGraphUri()));
		
		list.addAll(_dataset.find(_resource, restProperty, null, _graph.getNamedGraphUri()));
		
		
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.rdf.rdfs.List.TYPE, _graph.getNamedGraphUri()));
	 ...
	 * @see			org.openanzo.rdf.rdfs.List#commentProperty
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#comment
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionComment = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#comment properties in List model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.List#labelProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#label
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionLabel = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#label properties in List model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.List#typeProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.List#valueProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.List#isDefinedByProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.List#memberProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.List#seeAlsoProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	...
	/**
	 * Clears all values for 'first'. 
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.List#firstProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
	public void clearFirst(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException{
		_dataset.remove(_resource, firstProperty, null,(includeEntireDataset)?null:_graph.getNamedGraphUri());
	}
// generating for property: http://www.w3.org/1999/02/22-rdf-syntax-ns#first

// generating range: http://jastor.adtech.ibm.com/defaultRange

	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.rdfs._Resource> propertyCollectionFirst = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.rdfs._Resource>() {
		public org.openanzo.rdf.rdfs._Resource getPropertyValue(org.openanzo.rdf.Value resource) {
			try {
				return org.openanzo.rdf.rdfs.RDFSFactory.get_Resource((org.openanzo.rdf.Resource)resource,_graph.getNamedGraphUri(),dataset());
			} catch (org.openanzo.rdf.jastor.JastorException e) {
	...
	public java.util.Collection<org.openanzo.rdf.rdfs._Resource> getFirst(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		return propertyCollectionFirst.getPropertyCollection(_dataset, _graph, _resource,firstProperty, org.openanzo.rdf.MemURI.create("http://www.w3.org/2000/01/rdf-schema#Resource"), includeEntireDataset);
	}
	
	public java.util.Collection<org.openanzo.rdf.rdfs._Resource> getFirst() throws org.openanzo.rdf.jastor.JastorException {
		return getFirst(false);
	}

	public void addFirst(org.openanzo.rdf.rdfs._Resource first) throws org.openanzo.rdf.jastor.JastorException {
		_dataset.add(_resource, firstProperty,first.resource(),_graph.getNamedGraphUri());
	}
	
	public org.openanzo.rdf.rdfs._Resource addFirst() throws org.openanzo.rdf.jastor.JastorException {
		org.openanzo.rdf.rdfs._Resource first = org.openanzo.rdf.rdfs.RDFSFactory.create_Resource(org.openanzo.rdf.jastor.ThingFactory.valueFactory.createBNode(),_graph.getNamedGraphUri(),_dataset);
		_dataset.add(_resource, firstProperty,first.resource(),_graph.getNamedGraphUri());
		return first;
	}
	
	public org.openanzo.rdf.rdfs._Resource addFirst(org.openanzo.rdf.Resource resource) throws org.openanzo.rdf.jastor.JastorException {
		org.openanzo.rdf.rdfs._Resource first = org.openanzo.rdf.rdfs.RDFSFactory.get_Resource(resource,_graph.getNamedGraphUri(),_dataset);
		_dataset.add(_resource, firstProperty,first.resource(),_graph.getNamedGraphUri());
		return first;
	}
	
	public void removeFirst(org.openanzo.rdf.rdfs._Resource first) throws org.openanzo.rdf.jastor.JastorException {
		if (!_dataset.contains(_resource, firstProperty, first.resource(),_graph.getNamedGraphUri()))
			return;
		_dataset.remove(_resource, firstProperty, first.resource(),_graph.getNamedGraphUri());
	}
	

		

	public void removeFirst(org.openanzo.rdf.Resource resource) throws org.openanzo.rdf.jastor.JastorException {
		if (!_dataset.contains(_resource, firstProperty, resource,_graph.getNamedGraphUri()))
			return;
		_dataset.remove(_resource, firstProperty, resource,_graph.getNamedGraphUri());
	}
 
	/**
	 * Clears all values for 'rest'. 
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.List#restProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
	public void clearRest(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException{
		_dataset.remove(_resource, restProperty, null,(includeEntireDataset)?null:_graph.getNamedGraphUri());
	}
// generating for property: http://www.w3.org/1999/02/22-rdf-syntax-ns#rest

// generating range: http://jastor.adtech.ibm.com/defaultRange

	org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.rdfs.List> propertyCollectionRest = new org.openanzo.rdf.jastor.PropertyCollection<org.openanzo.rdf.rdfs.List>() {
		public org.openanzo.rdf.rdfs.List getPropertyValue(org.openanzo.rdf.Value resource) {
			try {
				return org.openanzo.rdf.rdfs.RDFSFactory.getList((org.openanzo.rdf.Resource)resource,_graph.getNamedGraphUri(),dataset());
			} catch (org.openanzo.rdf.jastor.JastorException e) {
				throw new java.util.NoSuchElementException(e.getMessage());
			}
		}
	...
	public java.util.Collection<org.openanzo.rdf.rdfs.List> getRest(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		return propertyCollectionRest.getPropertyCollection(_dataset, _graph, _resource,restProperty, org.openanzo.rdf.MemURI.create("http://www.w3.org/1999/02/22-rdf-syntax-ns#List"), includeEntireDataset);
	}
	
	public java.util.Collection<org.openanzo.rdf.rdfs.List> getRest() throws org.openanzo.rdf.jastor.JastorException {
		return getRest(false);
	}

	public void addRest(org.openanzo.rdf.rdfs.List rest) throws org.openanzo.rdf.jastor.JastorException {
		_dataset.add(_resource, restProperty,rest.resource(),_graph.getNamedGraphUri());
	}
	
	public org.openanzo.rdf.rdfs.List addRest() throws org.openanzo.rdf.jastor.JastorException {
		org.openanzo.rdf.rdfs.List rest = org.openanzo.rdf.rdfs.RDFSFactory.createList(org.openanzo.rdf.jastor.ThingFactory.valueFactory.createBNode(),_graph.getNamedGraphUri(),_dataset);
		_dataset.add(_resource, restProperty,rest.resource(),_graph.getNamedGraphUri());
		return rest;
	}
	
	public org.openanzo.rdf.rdfs.List addRest(org.openanzo.rdf.Resource resource) throws org.openanzo.rdf.jastor.JastorException {
		org.openanzo.rdf.rdfs.List rest = org.openanzo.rdf.rdfs.RDFSFactory.getList(resource,_graph.getNamedGraphUri(),_dataset);
		_dataset.add(_resource, restProperty,rest.resource(),_graph.getNamedGraphUri());
		return rest;
	}
	
	public void removeRest(org.openanzo.rdf.rdfs.List rest) throws org.openanzo.rdf.jastor.JastorException {
		if (!_dataset.contains(_resource, restProperty, rest.resource(),_graph.getNamedGraphUri()))
			return;
		_dataset.remove(_resource, restProperty, rest.resource(),_graph.getNamedGraphUri());
	}
	

		

	public void removeRest(org.openanzo.rdf.Resource resource) throws org.openanzo.rdf.jastor.JastorException {
		if (!_dataset.contains(_resource, restProperty, resource,_graph.getNamedGraphUri()))
			return;
		_dataset.remove(_resource, restProperty, resource,_graph.getNamedGraphUri());
	}

...
/**
 * Interface for ContainerMembershipProperty ontology class<br>
 ...
 * 	label : ContainerMembershipProperty <br>
 * 	comment : The class of container membership properties, rdf:_1, rdf:_2, ...,
	                    all of which are sub-properties of 'member'. <br>
 * <br>
 * <br>
 */
public interface ContainerMembershipProperty extends 
org.openanzo.rdf.rdfs._Property, org.openanzo.rdf.jastor.Thing {
	
	/**
	 * The rdf:type for this ontology class
     */
	public static final org.openanzo.rdf.URI TYPE = org.openanzo.rdf.jastor.ThingFactory.valueFactory.createURI("http://www.w3.org/2000/01/rdf-schema#ContainerMembershipProperty");

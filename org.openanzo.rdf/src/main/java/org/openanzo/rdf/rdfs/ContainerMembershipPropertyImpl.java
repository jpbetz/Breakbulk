...
/**
 * Implementation of {@link org.openanzo.rdf.rdfs.ContainerMembershipProperty}
 * Use the org.openanzo.rdf.rdfs.RDFSFactory to create instances of this class.
 * <p>(URI: http://www.w3.org/2000/01/rdf-schema#ContainerMembershipProperty)</p>
 * <br>
 */
public class ContainerMembershipPropertyImpl extends org.openanzo.rdf.jastor.ThingImpl implements org.openanzo.rdf.rdfs.ContainerMembershipProperty {
	...
	ContainerMembershipPropertyImpl(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		super(resource, namedGraphUri, dataset);
	}   
	   
    	
	static ContainerMembershipPropertyImpl getContainerMembershipProperty(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException {
		if(namedGraphUri==null||!dataset.containsNamedGraph(namedGraphUri) ){
			namedGraphUri=null;
			for(org.openanzo.rdf.Statement stmt:dataset.find(resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, ContainerMembershipProperty.TYPE)){
				namedGraphUri=stmt.getNamedGraphUri();
			}
			if(namedGraphUri==null)return null;
		}
		return new ContainerMembershipPropertyImpl(resource, namedGraphUri, dataset);
	}
	    
	static ContainerMembershipPropertyImpl createContainerMembershipProperty(org.openanzo.rdf.Resource resource,org.openanzo.rdf.URI namedGraphUri, org.openanzo.rdf.IDataset dataset) throws org.openanzo.rdf.jastor.JastorException { 
		
		ContainerMembershipPropertyImpl impl = new ContainerMembershipPropertyImpl(resource, namedGraphUri,dataset);
		if (!impl._dataset.contains(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, ContainerMembershipProperty.TYPE, namedGraphUri))
			impl._dataset.add(impl._resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, ContainerMembershipProperty.TYPE, namedGraphUri);
		impl.addSuperTypes();
	...
	public java.util.Collection<org.openanzo.rdf.Statement> listStatements() {
		...
		list.addAll(_dataset.find(_resource,  org.openanzo.rdf.vocabulary.RDF.TYPE, org.openanzo.rdf.rdfs.ContainerMembershipProperty.TYPE, _graph.getNamedGraphUri()));
	 ...
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#commentProperty
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#comment
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionComment = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#comment properties in ContainerMembershipProperty model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#labelProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#label
	...
	org.openanzo.rdf.jastor.PropertyCollection<java.lang.String> propertyCollectionLabel = new org.openanzo.rdf.jastor.PropertyCollection<java.lang.String>() {
		public java.lang.String getPropertyValue(org.openanzo.rdf.Value value) {
				...
				if(value instanceof org.openanzo.rdf.Literal){
					...
					throw new org.openanzo.rdf.jastor.InvalidNodeException (uri() + ": One of the http://www.w3.org/2000/01/rdf-schema#label properties in ContainerMembershipProperty model not a Literal",value);
				}
			}
	};
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#typeProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#valueProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#isDefinedByProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#memberProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#seeAlsoProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating range: http://jastor.adtech.ibm.com/defaultRange
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#domainProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#domain
	...
	public org.openanzo.rdf.rdfs.Class getDomain(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": domain getProperty() in org.openanzo.rdf.rdfs.ContainerMembershipProperty model not Resource", statement.getObject());
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#rangeProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */
...
// generating for property: http://www.w3.org/2000/01/rdf-schema#range
	...
	public org.openanzo.rdf.rdfs.Class getRange(boolean includeEntireDataset) throws org.openanzo.rdf.jastor.JastorException {
		...
		if (statement == null)
			return null;
		if (!((statement.getObject() instanceof org.openanzo.rdf.URI)||(statement.getObject() instanceof org.openanzo.rdf.BlankNode)))
			throw new org.openanzo.rdf.jastor.InvalidNodeException(uri() + ": range getProperty() in org.openanzo.rdf.rdfs.ContainerMembershipProperty model not Resource", statement.getObject());
		org.openanzo.rdf.Resource resource = (org.openanzo.rdf.Resource)statement.getObject();
		return org.openanzo.rdf.rdfs.RDFSFactory.getClass(resource,(includeEntireDataset)?null:_graph.getNamedGraphUri(),_dataset);
	 ...
	 * @param 		includeEntireDataset Delete the properties from the entire dataset, and not just the namedgraph
	 * @see			org.openanzo.rdf.rdfs.ContainerMembershipProperty#subPropertyOfProperty
	 * @throws org.openanzo.rdf.jastor.JastorException
	 */

...
:endInit
%_RUNJAVA% %ANZO_CLI_OPTS% -classpath "%ANZO_CLI_HOME%\plugins\cli\classworlds-1.0.1.jar" "-Danzo.lib=%ANZO_CLI_HOME%\lib" "-Dclassworlds.conf=%ANZO_CLI_HOME%/conf/classworlds.conf" "-Dlog4j.configuration="file://%ANZO_CLI_HOME%/conf/log4j.properties" org.codehaus.classworlds.Launcher %ANZO_CMD_LINE_ARGS%

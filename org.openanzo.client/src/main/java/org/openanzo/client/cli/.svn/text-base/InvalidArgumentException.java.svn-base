 ...
 * 
 */
public class InvalidArgumentException extends AnzoException {
    private static final long serialVersionUID = 5878320653497364042L;

    InvalidArgumentException(String... reason) {
        super(ExceptionConstants.CLIENT.COMMAND_ERROR, reason);
    }

    InvalidArgumentException(Throwable exception, String... reason) {

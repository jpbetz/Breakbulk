...
tests.register("anzo.tests.rdf.performance.QuadStorePerformanceTest3", 
	[
		...
		function test_Performance1() {
		    ...
		    var patterns = anzo.tests.utilities.addStmts(store, NUM_STMTS, NUM_STMTS, 1, NUM_STMTS, NUM_STMTS);
            console.debug("----------------------------------------------");

...
dojo.provide("anzo.tests.rdf.performance.QuadStorePerformanceTest5");
...
tests.register("anzo.tests.rdf.performance.QuadStorePerformanceTest5", 
	[
		...
		function test_Performance1() {
		    ...
		    console.debug("   This test adds statements that have the same graph uris, but don't share any of the subjects, predicates or objects.");
		    
		    var store = new anzo.rdf.QuadStore();
		     
		    var patterns = anzo.tests.utilities.addStmts(store, NUM_STMTS, NUM_STMTS, NUM_STMTS, NUM_STMTS, 1);
            console.debug("----------------------------------------------");

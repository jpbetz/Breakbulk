...
dojo.provide("anzo.tests.rdf.performance.QuadStorePerformanceTest4");
...
tests.register("anzo.tests.rdf.performance.QuadStorePerformanceTest4", 
	[
		...
		function test_Performance1() {
		    ...
		    console.debug("   This test adds statements that have the same objects, but don't share any of the subjects, predicates or named graphs.");
		    
		    var store = new anzo.rdf.QuadStore();
		     
		    var patterns = anzo.tests.utilities.addStmts(store, NUM_STMTS, NUM_STMTS, NUM_STMTS, 1, NUM_STMTS);
            console.debug("----------------------------------------------");

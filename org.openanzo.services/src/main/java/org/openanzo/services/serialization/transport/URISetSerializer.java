...
public class URISetSerializer {
    ...
    static public java.util.Set<org.openanzo.rdf.URI> deserialize(String serialized, String format) throws AnzoException {
        if (serialized == null || serialized.length() == 0)
            return Collections.<org.openanzo.rdf.URI> emptySet();
        return org.openanzo.rdf.utils.SerializationUtils.convertStringToSet(serialized, format);
    }
     ...
     */
    static private String serialize(java.util.Set<org.openanzo.rdf.URI> object, String format) throws AnzoException {
     ...
     *             if there was a problem serializing the object
     */
    static public void serialize(java.util.Set<org.openanzo.rdf.URI> object, String propertyName, String format, IMessage message) throws AnzoException {
     ...
     *             if there was a problem deserializing the object
     */
    static public java.util.Set<org.openanzo.rdf.URI> deserialize(IMessage message, String propertyName, String format) throws AnzoException {
        if (message.getUseMultiValueProperties()) {

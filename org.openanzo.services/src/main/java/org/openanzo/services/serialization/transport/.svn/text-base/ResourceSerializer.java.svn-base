...
public class ResourceSerializer {
     ...
     */
    static public Resource deserialize(String serialized, String format) throws AnzoException {
        return Constants.valueFactory.createResource(serialized);
    }
     ...
     */
    static public String serialize(Resource object, String format) throws AnzoException {
        if (object instanceof BlankNode) {
            return ((BlankNode) object).toString();
        } else {
     ...
     *             if there was a problem serializing the object
     */
    static public void serialize(Resource object, String propertyName, String format, IMessage message) throws AnzoException {
     ...
     *             if there was a problem deserializing the object
     */
    static public Resource deserialize(IMessage message, String propertyName, String format) throws AnzoException {

...
public class StringSerializer {
     ...
     */
    static private String deserialize(String serialized, String format) throws AnzoException {
        return serialized;
    }
     ...
     */
    static public String serialize(String object, String format) throws AnzoException {
        return object;
    }
     ...
     *             if there was a problem serializing the object
     */
    static public void serialize(String object, String propertyName, String format, IMessage message) throws AnzoException {
     ...
     *             if there was a problem deserializing the object
     */
    static public String deserialize(IMessage message, String propertyName, String format) throws AnzoException {

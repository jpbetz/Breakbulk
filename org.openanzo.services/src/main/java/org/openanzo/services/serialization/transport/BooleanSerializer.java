...
public class BooleanSerializer {
     ...
     */
    static public boolean deserialize(String serialized, String format) throws AnzoException {
     ...
     */
    static private String serialize(boolean object, String format) throws AnzoException {
     ...
     *             if there was a problem serializing the object
     */
    static public void serialize(boolean object, String propertyName, String format, IMessage message) throws AnzoException {
     ...
     *             if there was a problem deserializing the object
     */
    static public boolean deserialize(IMessage message, String propertyName, String format) throws AnzoException {

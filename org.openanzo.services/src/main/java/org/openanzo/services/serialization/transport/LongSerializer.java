...
public class LongSerializer {
     ...
     */
    static public long deserialize(String serialized, String format) throws AnzoException {
     ...
     */
    static private String serialize(long object, String format) throws AnzoException {
     ...
     *             if there was a problem serializing the object
     */
    static public void serialize(long object, String propertyName, String format, IMessage message) throws AnzoException {
     ...
     *             if there was a problem deserializing the object
     */
    static public long deserialize(IMessage message, String propertyName, String format) throws AnzoException {

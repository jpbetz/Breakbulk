...
public class PrivilegeSerializer {
     ...
     */
    static public Privilege deserialize(String serialized, String format) throws AnzoException {
        if (serialized == null || serialized.length() == 0)
            return null;
        return Privilege.valueOf(serialized);
    }
     ...
     */
    static public String serialize(Privilege object, String format) throws AnzoException {
        return object.name();
    }
     ...
     *             if there was a problem serializing the object
     */
    static public void serialize(Privilege object, String propertyName, String format, IMessage message) throws AnzoException {
     ...
     *             if there was a problem deserializing the object
     */
    static public Privilege deserialize(IMessage message, String propertyName, String format) throws AnzoException {
